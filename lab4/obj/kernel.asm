...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	5eb030ef          	jal	ra,ffffffffc0203e4c <memset>
    dtb_init();
...
ffffffffc0200072:	e3258593          	addi	a1,a1,-462 # ffffffffc0203ea0 <etext+0x6>
ffffffffc0200076:	00004517          	auipc	a0,0x4
ffffffffc020007a:	e4a50513          	addi	a0,a0,-438 # ffffffffc0203ec0 <etext+0x26>
...
ffffffffc0200096:	576030ef          	jal	ra,ffffffffc020360c <proc_init>
...
ffffffffc02000a2:	7b8030ef          	jal	ra,ffffffffc020385a <cpu_idle>
...
ffffffffc02000c0:	e0c50513          	addi	a0,a0,-500 # ffffffffc0203ec8 <etext+0x2e>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	0a1030ef          	jal	ra,ffffffffc0203a28 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	06b030ef          	jal	ra,ffffffffc0203a28 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001e2:	cf250513          	addi	a0,a0,-782 # ffffffffc0203ed0 <etext+0x36>
{
...
ffffffffc02001f8:	cfc50513          	addi	a0,a0,-772 # ffffffffc0203ef0 <etext+0x56>
ffffffffc02001fc:	f99ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200200:	00004597          	auipc	a1,0x4
ffffffffc0200204:	c9a58593          	addi	a1,a1,-870 # ffffffffc0203e9a <etext>
ffffffffc0200208:	00004517          	auipc	a0,0x4
ffffffffc020020c:	d0850513          	addi	a0,a0,-760 # ffffffffc0203f10 <etext+0x76>
...
ffffffffc0200220:	d1450513          	addi	a0,a0,-748 # ffffffffc0203f30 <etext+0x96>
...
ffffffffc0200234:	d2050513          	addi	a0,a0,-736 # ffffffffc0203f50 <etext+0xb6>
...
ffffffffc0200262:	d1250513          	addi	a0,a0,-750 # ffffffffc0203f70 <etext+0xd6>
}
...
ffffffffc0200270:	d3460613          	addi	a2,a2,-716 # ffffffffc0203fa0 <etext+0x106>
ffffffffc0200274:	04900593          	li	a1,73
ffffffffc0200278:	00004517          	auipc	a0,0x4
ffffffffc020027c:	d4050513          	addi	a0,a0,-704 # ffffffffc0203fb8 <etext+0x11e>
{
...
ffffffffc020028c:	d4860613          	addi	a2,a2,-696 # ffffffffc0203fd0 <etext+0x136>
ffffffffc0200290:	00004597          	auipc	a1,0x4
ffffffffc0200294:	d6058593          	addi	a1,a1,-672 # ffffffffc0203ff0 <etext+0x156>
ffffffffc0200298:	00004517          	auipc	a0,0x4
ffffffffc020029c:	d6050513          	addi	a0,a0,-672 # ffffffffc0203ff8 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002aa:	d6260613          	addi	a2,a2,-670 # ffffffffc0204008 <etext+0x16e>
ffffffffc02002ae:	00004597          	auipc	a1,0x4
ffffffffc02002b2:	d8258593          	addi	a1,a1,-638 # ffffffffc0204030 <etext+0x196>
ffffffffc02002b6:	00004517          	auipc	a0,0x4
ffffffffc02002ba:	d4250513          	addi	a0,a0,-702 # ffffffffc0203ff8 <etext+0x15e>
ffffffffc02002be:	ed7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002c2:	00004617          	auipc	a2,0x4
ffffffffc02002c6:	d7e60613          	addi	a2,a2,-642 # ffffffffc0204040 <etext+0x1a6>
ffffffffc02002ca:	00004597          	auipc	a1,0x4
ffffffffc02002ce:	d9658593          	addi	a1,a1,-618 # ffffffffc0204060 <etext+0x1c6>
ffffffffc02002d2:	00004517          	auipc	a0,0x4
ffffffffc02002d6:	d2650513          	addi	a0,a0,-730 # ffffffffc0203ff8 <etext+0x15e>
...
ffffffffc0200310:	d6450513          	addi	a0,a0,-668 # ffffffffc0204070 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200332:	d6a50513          	addi	a0,a0,-662 # ffffffffc0204098 <etext+0x1fe>
...
ffffffffc020035c:	d6890913          	addi	s2,s2,-664 # ffffffffc02040c0 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200360:	00004497          	auipc	s1,0x4
ffffffffc0200364:	d6848493          	addi	s1,s1,-664 # ffffffffc02040c8 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020036a:	00004b17          	auipc	s6,0x4
ffffffffc020036e:	d66b0b13          	addi	s6,s6,-666 # ffffffffc02040d0 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc0200372:	00004a17          	auipc	s4,0x4
ffffffffc0200376:	c7ea0a13          	addi	s4,s4,-898 # ffffffffc0203ff0 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	251030ef          	jal	ra,ffffffffc0203df2 <strcmp>
...
ffffffffc02003b4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003b6:	23d030ef          	jal	ra,ffffffffc0203df2 <strcmp>
...
ffffffffc02003f4:	243030ef          	jal	ra,ffffffffc0203e36 <strchr>
...
ffffffffc0200432:	205030ef          	jal	ra,ffffffffc0203e36 <strchr>
...
ffffffffc0200450:	ca450513          	addi	a0,a0,-860 # ffffffffc02040f0 <etext+0x256>
...
ffffffffc0200746:	664030ef          	jal	ra,ffffffffc0203daa <strlen>
...
ffffffffc0200752:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc0200754:	6bc030ef          	jal	ra,ffffffffc0203e10 <strncmp>
...
ffffffffc02007ea:	608030ef          	jal	ra,ffffffffc0203df2 <strcmp>
...
ffffffffc0200c36:	00000073          	ecall
                    while (1)
ffffffffc0200c3a:	a001                	j	ffffffffc0200c3a <interrupt_handler+0xb8>
...
ffffffffc0201de0:	06c020ef          	jal	ra,ffffffffc0203e4c <memset>
    return page - pages + nbase;
...
ffffffffc0201e82:	7cb010ef          	jal	ra,ffffffffc0203e4c <memset>
    return page - pages + nbase;
...
ffffffffc02025fa:	7e6010ef          	jal	ra,ffffffffc0203de0 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02025fe:	10040593          	addi	a1,s0,256
ffffffffc0202602:	10000513          	li	a0,256
ffffffffc0202606:	7ec010ef          	jal	ra,ffffffffc0203df2 <strcmp>
...
ffffffffc0202638:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc020263c:	76e010ef          	jal	ra,ffffffffc0203daa <strlen>
...
ffffffffc0203202:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0203204:	3ec000ef          	jal	ra,ffffffffc02035f0 <do_exit>
...
ffffffffc0203216:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc0203218:	cd21                	beqz	a0,ffffffffc0203270 <alloc_proc+0x68>
...
ffffffffc020324a:	f45c                	sd	a5,168(s0)
        proc->tf = NULL;                            // 初始化陷阱帧为NULL
ffffffffc020324c:	0a043023          	sd	zero,160(s0)
...
ffffffffc020325c:	3f1000ef          	jal	ra,ffffffffc0203e4c <memset>
        // 补充
        list_init(&(proc->list_link));
ffffffffc0203260:	0c840713          	addi	a4,s0,200
        list_init(&(proc->hash_link));
ffffffffc0203264:	0d840793          	addi	a5,s0,216
    elm->prev = elm->next = elm;
...
ffffffffc0203284:	b4dfd06f          	j	ffffffffc0200dd0 <forkrets>
...
ffffffffc02032d6:	34650513          	addi	a0,a0,838 # ffffffffc0205618 <default_pmm_manager+0x948>
ffffffffc02032da:	ebbfc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02032de:	00002517          	auipc	a0,0x2
ffffffffc02032e2:	34a50513          	addi	a0,a0,842 # ffffffffc0205628 <default_pmm_manager+0x958>
...
ffffffffc020333a:	53c000ef          	jal	ra,ffffffffc0203876 <switch_to>
    if (flag) {
...
ffffffffc020336a:	0000a497          	auipc	s1,0xa
ffffffffc020336e:	17e48493          	addi	s1,s1,382 # ffffffffc020d4e8 <nr_process>
ffffffffc0203372:	4098                	lw	a4,0(s1)
{
ffffffffc0203374:	f406                	sd	ra,40(sp)
ffffffffc0203376:	f022                	sd	s0,32(sp)
ffffffffc0203378:	e84a                	sd	s2,16(sp)
ffffffffc020337a:	e44e                	sd	s3,8(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc020337c:	6785                	lui	a5,0x1
ffffffffc020337e:	1cf75e63          	bge	a4,a5,ffffffffc020355a <do_fork+0x1f4>
ffffffffc0203382:	892e                	mv	s2,a1
ffffffffc0203384:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0203386:	e83ff0ef          	jal	ra,ffffffffc0203208 <alloc_proc>
ffffffffc020338a:	89aa                	mv	s3,a0
ffffffffc020338c:	1c050c63          	beqz	a0,ffffffffc0203564 <do_fork+0x1fe>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0203390:	4509                	li	a0,2
ffffffffc0203392:	8fffe0ef          	jal	ra,ffffffffc0201c90 <alloc_pages>
    if (page != NULL)
ffffffffc0203396:	1a050d63          	beqz	a0,ffffffffc0203550 <do_fork+0x1ea>
    return page - pages + nbase;
...
ffffffffc02033ac:	64053503          	ld	a0,1600(a0) # ffffffffc02059e8 <nbase>
...
ffffffffc02033c0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02033c2:	1ce7f363          	bgeu	a5,a4,ffffffffc0203588 <do_fork+0x222>
    assert(current->mm == NULL);
ffffffffc02033c6:	0000a317          	auipc	t1,0xa
ffffffffc02033ca:	10a33303          	ld	t1,266(t1) # ffffffffc020d4d0 <current>
ffffffffc02033ce:	02833783          	ld	a5,40(t1)
ffffffffc02033d2:	0000a717          	auipc	a4,0xa
ffffffffc02033d6:	0f673703          	ld	a4,246(a4) # ffffffffc020d4c8 <va_pa_offset>
ffffffffc02033da:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02033dc:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02033e0:	18079463          	bnez	a5,ffffffffc0203568 <do_fork+0x202>
...
ffffffffc0203414:	ff1612e3          	bne	a2,a7,ffffffffc02033f8 <do_fork+0x92>
    proc->tf->gpr.a0 = 0;
ffffffffc0203418:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020341c:	10090e63          	beqz	s2,ffffffffc0203538 <do_fork+0x1d2>
    if (++last_pid >= MAX_PID)
ffffffffc0203420:	00006817          	auipc	a6,0x6
ffffffffc0203424:	c0880813          	addi	a6,a6,-1016 # ffffffffc0209028 <last_pid.1>
ffffffffc0203428:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020342c:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203430:	00000717          	auipc	a4,0x0
ffffffffc0203434:	e4a70713          	addi	a4,a4,-438 # ffffffffc020327a <forkret>
    if (++last_pid >= MAX_PID)
ffffffffc0203438:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020343c:	02e9b823          	sd	a4,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0203440:	02d9bc23          	sd	a3,56(s3)
    if (++last_pid >= MAX_PID)
ffffffffc0203444:	00a82023          	sw	a0,0(a6)
ffffffffc0203448:	6789                	lui	a5,0x2
ffffffffc020344a:	08f55063          	bge	a0,a5,ffffffffc02034ca <do_fork+0x164>
    if (last_pid >= next_safe)
ffffffffc020344e:	00006e17          	auipc	t3,0x6
ffffffffc0203452:	bdee0e13          	addi	t3,t3,-1058 # ffffffffc020902c <next_safe.0>
ffffffffc0203456:	000e2783          	lw	a5,0(t3)
ffffffffc020345a:	0000a417          	auipc	s0,0xa
ffffffffc020345e:	ffe40413          	addi	s0,s0,-2 # ffffffffc020d458 <proc_list>
ffffffffc0203462:	06f55c63          	bge	a0,a5,ffffffffc02034da <do_fork+0x174>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203466:	45a9                	li	a1,10
    proc->pid    = get_pid();
ffffffffc0203468:	00a9a223          	sw	a0,4(s3)
    proc->parent = current;
ffffffffc020346c:	0269b023          	sd	t1,32(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203470:	2501                	sext.w	a0,a0
ffffffffc0203472:	534000ef          	jal	ra,ffffffffc02039a6 <hash32>
ffffffffc0203476:	02051793          	slli	a5,a0,0x20
ffffffffc020347a:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020347e:	00006797          	auipc	a5,0x6
ffffffffc0203482:	fca78793          	addi	a5,a5,-54 # ffffffffc0209448 <hash_list>
ffffffffc0203486:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0203488:	6518                	ld	a4,8(a0)
ffffffffc020348a:	0d898793          	addi	a5,s3,216
ffffffffc020348e:	6414                	ld	a3,8(s0)
    prev->next = next->prev = elm;
ffffffffc0203490:	e31c                	sd	a5,0(a4)
ffffffffc0203492:	e51c                	sd	a5,8(a0)
    nr_process++;
ffffffffc0203494:	409c                	lw	a5,0(s1)
    elm->next = next;
ffffffffc0203496:	0ee9b023          	sd	a4,224(s3)
    elm->prev = prev;
ffffffffc020349a:	0ca9bc23          	sd	a0,216(s3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc020349e:	0c898713          	addi	a4,s3,200
    prev->next = next->prev = elm;
ffffffffc02034a2:	e298                	sd	a4,0(a3)
    nr_process++;
ffffffffc02034a4:	2785                	addiw	a5,a5,1
    wakeup_proc(proc);
ffffffffc02034a6:	854e                	mv	a0,s3
    elm->next = next;
ffffffffc02034a8:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02034ac:	0c89b423          	sd	s0,200(s3)
    prev->next = next->prev = elm;
ffffffffc02034b0:	e418                	sd	a4,8(s0)
    nr_process++;
ffffffffc02034b2:	c09c                	sw	a5,0(s1)
    wakeup_proc(proc);
ffffffffc02034b4:	42c000ef          	jal	ra,ffffffffc02038e0 <wakeup_proc>
    ret = proc->pid;
...
ffffffffc02034cc:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02034d0:	4505                	li	a0,1
ffffffffc02034d2:	00006e17          	auipc	t3,0x6
ffffffffc02034d6:	b5ae0e13          	addi	t3,t3,-1190 # ffffffffc020902c <next_safe.0>
    return listelm->next;
ffffffffc02034da:	0000a417          	auipc	s0,0xa
ffffffffc02034de:	f7e40413          	addi	s0,s0,-130 # ffffffffc020d458 <proc_list>
ffffffffc02034e2:	00843e83          	ld	t4,8(s0)
        next_safe = MAX_PID;
ffffffffc02034e6:	6789                	lui	a5,0x2
ffffffffc02034e8:	00fe2023          	sw	a5,0(t3)
ffffffffc02034ec:	86aa                	mv	a3,a0
ffffffffc02034ee:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc02034f0:	6f09                	lui	t5,0x2
ffffffffc02034f2:	048e8a63          	beq	t4,s0,ffffffffc0203546 <do_fork+0x1e0>
ffffffffc02034f6:	88ae                	mv	a7,a1
ffffffffc02034f8:	87f6                	mv	a5,t4
ffffffffc02034fa:	6609                	lui	a2,0x2
ffffffffc02034fc:	a811                	j	ffffffffc0203510 <do_fork+0x1aa>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc02034fe:	00e6d663          	bge	a3,a4,ffffffffc020350a <do_fork+0x1a4>
ffffffffc0203502:	00c75463          	bge	a4,a2,ffffffffc020350a <do_fork+0x1a4>
ffffffffc0203506:	863a                	mv	a2,a4
ffffffffc0203508:	4885                	li	a7,1
ffffffffc020350a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc020350c:	00878d63          	beq	a5,s0,ffffffffc0203526 <do_fork+0x1c0>
            if (proc->pid == last_pid)
ffffffffc0203510:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0203514:	fed715e3          	bne	a4,a3,ffffffffc02034fe <do_fork+0x198>
                if (++last_pid >= next_safe)
ffffffffc0203518:	2685                	addiw	a3,a3,1
ffffffffc020351a:	02c6d163          	bge	a3,a2,ffffffffc020353c <do_fork+0x1d6>
ffffffffc020351e:	679c                	ld	a5,8(a5)
ffffffffc0203520:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc0203522:	fe8797e3          	bne	a5,s0,ffffffffc0203510 <do_fork+0x1aa>
ffffffffc0203526:	c581                	beqz	a1,ffffffffc020352e <do_fork+0x1c8>
ffffffffc0203528:	00d82023          	sw	a3,0(a6)
ffffffffc020352c:	8536                	mv	a0,a3
ffffffffc020352e:	f2088ce3          	beqz	a7,ffffffffc0203466 <do_fork+0x100>
ffffffffc0203532:	00ce2023          	sw	a2,0(t3)
ffffffffc0203536:	bf05                	j	ffffffffc0203466 <do_fork+0x100>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203538:	8936                	mv	s2,a3
ffffffffc020353a:	b5dd                	j	ffffffffc0203420 <do_fork+0xba>
                    if (last_pid >= MAX_PID)
ffffffffc020353c:	01e6c363          	blt	a3,t5,ffffffffc0203542 <do_fork+0x1dc>
                        last_pid = 1;
ffffffffc0203540:	4685                	li	a3,1
                    goto repeat;
ffffffffc0203542:	4585                	li	a1,1
ffffffffc0203544:	b77d                	j	ffffffffc02034f2 <do_fork+0x18c>
ffffffffc0203546:	cd81                	beqz	a1,ffffffffc020355e <do_fork+0x1f8>
ffffffffc0203548:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020354c:	8536                	mv	a0,a3
ffffffffc020354e:	bf21                	j	ffffffffc0203466 <do_fork+0x100>
    kfree(proc);
ffffffffc0203550:	854e                	mv	a0,s3
ffffffffc0203552:	e10fe0ef          	jal	ra,ffffffffc0201b62 <kfree>
    ret = -E_NO_MEM;
ffffffffc0203556:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0203558:	b795                	j	ffffffffc02034bc <do_fork+0x156>
    int ret = -E_NO_FREE_PROC;
ffffffffc020355a:	556d                	li	a0,-5
ffffffffc020355c:	b785                	j	ffffffffc02034bc <do_fork+0x156>
    return last_pid;
ffffffffc020355e:	00082503          	lw	a0,0(a6)
ffffffffc0203562:	b711                	j	ffffffffc0203466 <do_fork+0x100>
    ret = -E_NO_MEM;
ffffffffc0203564:	5571                	li	a0,-4
    return ret;
ffffffffc0203566:	bf99                	j	ffffffffc02034bc <do_fork+0x156>
    assert(current->mm == NULL);
ffffffffc0203568:	00002697          	auipc	a3,0x2
ffffffffc020356c:	0e068693          	addi	a3,a3,224 # ffffffffc0205648 <default_pmm_manager+0x978>
ffffffffc0203570:	00001617          	auipc	a2,0x1
ffffffffc0203574:	3b060613          	addi	a2,a2,944 # ffffffffc0204920 <commands+0x818>
ffffffffc0203578:	12600593          	li	a1,294
ffffffffc020357c:	00002517          	auipc	a0,0x2
ffffffffc0203580:	0e450513          	addi	a0,a0,228 # ffffffffc0205660 <default_pmm_manager+0x990>
ffffffffc0203584:	ed7fc0ef          	jal	ra,ffffffffc020045a <__panic>
ffffffffc0203588:	00001617          	auipc	a2,0x1
ffffffffc020358c:	78060613          	addi	a2,a2,1920 # ffffffffc0204d08 <default_pmm_manager+0x38>
ffffffffc0203590:	07100593          	li	a1,113
ffffffffc0203594:	00001517          	auipc	a0,0x1
ffffffffc0203598:	79c50513          	addi	a0,a0,1948 # ffffffffc0204d30 <default_pmm_manager+0x60>
ffffffffc020359c:	ebffc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc02035a0 <kernel_thread>:
{
ffffffffc02035a0:	7129                	addi	sp,sp,-320
ffffffffc02035a2:	fa22                	sd	s0,304(sp)
ffffffffc02035a4:	f626                	sd	s1,296(sp)
ffffffffc02035a6:	f24a                	sd	s2,288(sp)
ffffffffc02035a8:	84ae                	mv	s1,a1
ffffffffc02035aa:	892a                	mv	s2,a0
ffffffffc02035ac:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035ae:	4581                	li	a1,0
ffffffffc02035b0:	12000613          	li	a2,288
ffffffffc02035b4:	850a                	mv	a0,sp
{
ffffffffc02035b6:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035b8:	095000ef          	jal	ra,ffffffffc0203e4c <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02035bc:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02035be:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02035c0:	100027f3          	csrr	a5,sstatus
ffffffffc02035c4:	edd7f793          	andi	a5,a5,-291
ffffffffc02035c8:	1207e793          	ori	a5,a5,288
ffffffffc02035cc:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035ce:	860a                	mv	a2,sp
ffffffffc02035d0:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035d4:	00000797          	auipc	a5,0x0
ffffffffc02035d8:	c2c78793          	addi	a5,a5,-980 # ffffffffc0203200 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035dc:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035de:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035e0:	d87ff0ef          	jal	ra,ffffffffc0203366 <do_fork>
}
ffffffffc02035e4:	70f2                	ld	ra,312(sp)
ffffffffc02035e6:	7452                	ld	s0,304(sp)
ffffffffc02035e8:	74b2                	ld	s1,296(sp)
ffffffffc02035ea:	7912                	ld	s2,288(sp)
ffffffffc02035ec:	6131                	addi	sp,sp,320
ffffffffc02035ee:	8082                	ret

ffffffffc02035f0 <do_exit>:
{
ffffffffc02035f0:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02035f2:	00002617          	auipc	a2,0x2
ffffffffc02035f6:	08660613          	addi	a2,a2,134 # ffffffffc0205678 <default_pmm_manager+0x9a8>
ffffffffc02035fa:	19600593          	li	a1,406
ffffffffc02035fe:	00002517          	auipc	a0,0x2
ffffffffc0203602:	06250513          	addi	a0,a0,98 # ffffffffc0205660 <default_pmm_manager+0x990>
{
ffffffffc0203606:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0203608:	e53fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020360c <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and
//           - create the second kernel thread init_main
void proc_init(void)
{
ffffffffc020360c:	7179                	addi	sp,sp,-48
ffffffffc020360e:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0203610:	0000a797          	auipc	a5,0xa
ffffffffc0203614:	e4878793          	addi	a5,a5,-440 # ffffffffc020d458 <proc_list>
ffffffffc0203618:	f406                	sd	ra,40(sp)
ffffffffc020361a:	f022                	sd	s0,32(sp)
ffffffffc020361c:	e84a                	sd	s2,16(sp)
ffffffffc020361e:	e44e                	sd	s3,8(sp)
ffffffffc0203620:	00006497          	auipc	s1,0x6
ffffffffc0203624:	e2848493          	addi	s1,s1,-472 # ffffffffc0209448 <hash_list>
ffffffffc0203628:	e79c                	sd	a5,8(a5)
ffffffffc020362a:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc020362c:	0000a717          	auipc	a4,0xa
ffffffffc0203630:	e1c70713          	addi	a4,a4,-484 # ffffffffc020d448 <name.2>
ffffffffc0203634:	87a6                	mv	a5,s1
ffffffffc0203636:	e79c                	sd	a5,8(a5)
ffffffffc0203638:	e39c                	sd	a5,0(a5)
ffffffffc020363a:	07c1                	addi	a5,a5,16
ffffffffc020363c:	fef71de3          	bne	a4,a5,ffffffffc0203636 <proc_init+0x2a>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc0203640:	bc9ff0ef          	jal	ra,ffffffffc0203208 <alloc_proc>
ffffffffc0203644:	0000a917          	auipc	s2,0xa
ffffffffc0203648:	e9490913          	addi	s2,s2,-364 # ffffffffc020d4d8 <idleproc>
ffffffffc020364c:	00a93023          	sd	a0,0(s2)
ffffffffc0203650:	18050d63          	beqz	a0,ffffffffc02037ea <proc_init+0x1de>
    {
...
ffffffffc0203654:	07000513          	li	a0,112
ffffffffc0203658:	c5afe0ef          	jal	ra,ffffffffc0201ab2 <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020365c:	07000613          	li	a2,112
ffffffffc0203660:	4581                	li	a1,0
    int *context_mem = (int *)kmalloc(sizeof(struct context));
ffffffffc0203662:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0203664:	7e8000ef          	jal	ra,ffffffffc0203e4c <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0203668:	00093503          	ld	a0,0(s2)
ffffffffc020366c:	85a2                	mv	a1,s0
ffffffffc020366e:	07000613          	li	a2,112
ffffffffc0203672:	03050513          	addi	a0,a0,48
ffffffffc0203676:	001000ef          	jal	ra,ffffffffc0203e76 <memcmp>
ffffffffc020367a:	89aa                	mv	s3,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc020367c:	453d                	li	a0,15
ffffffffc020367e:	c34fe0ef          	jal	ra,ffffffffc0201ab2 <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0203682:	463d                	li	a2,15
ffffffffc0203684:	4581                	li	a1,0
    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc0203686:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0203688:	7c4000ef          	jal	ra,ffffffffc0203e4c <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc020368c:	00093503          	ld	a0,0(s2)
ffffffffc0203690:	463d                	li	a2,15
ffffffffc0203692:	85a2                	mv	a1,s0
ffffffffc0203694:	0b450513          	addi	a0,a0,180
ffffffffc0203698:	7de000ef          	jal	ra,ffffffffc0203e76 <memcmp>
...
ffffffffc020369c:	00093783          	ld	a5,0(s2)
ffffffffc02036a0:	0000a717          	auipc	a4,0xa
ffffffffc02036a4:	e0073703          	ld	a4,-512(a4) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc02036a8:	77d4                	ld	a3,168(a5)
ffffffffc02036aa:	0ee68463          	beq	a3,a4,ffffffffc0203792 <proc_init+0x186>
    {
...
ffffffffc02036ae:	4709                	li	a4,2
ffffffffc02036b0:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02036b2:	00003717          	auipc	a4,0x3
ffffffffc02036b6:	94e70713          	addi	a4,a4,-1714 # ffffffffc0206000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036ba:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02036be:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02036c0:	4705                	li	a4,1
ffffffffc02036c2:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036c4:	4641                	li	a2,16
ffffffffc02036c6:	4581                	li	a1,0
ffffffffc02036c8:	8522                	mv	a0,s0
ffffffffc02036ca:	782000ef          	jal	ra,ffffffffc0203e4c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02036ce:	463d                	li	a2,15
ffffffffc02036d0:	00002597          	auipc	a1,0x2
ffffffffc02036d4:	ff058593          	addi	a1,a1,-16 # ffffffffc02056c0 <default_pmm_manager+0x9f0>
ffffffffc02036d8:	8522                	mv	a0,s0
ffffffffc02036da:	784000ef          	jal	ra,ffffffffc0203e5e <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc02036de:	0000a717          	auipc	a4,0xa
ffffffffc02036e2:	e0a70713          	addi	a4,a4,-502 # ffffffffc020d4e8 <nr_process>
ffffffffc02036e6:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02036e8:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036ec:	4601                	li	a2,0
    nr_process++;
ffffffffc02036ee:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036f0:	00002597          	auipc	a1,0x2
ffffffffc02036f4:	fd858593          	addi	a1,a1,-40 # ffffffffc02056c8 <default_pmm_manager+0x9f8>
ffffffffc02036f8:	00000517          	auipc	a0,0x0
ffffffffc02036fc:	b9050513          	addi	a0,a0,-1136 # ffffffffc0203288 <init_main>
    nr_process++;
ffffffffc0203700:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0203702:	0000a797          	auipc	a5,0xa
ffffffffc0203706:	dcd7b723          	sd	a3,-562(a5) # ffffffffc020d4d0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020370a:	e97ff0ef          	jal	ra,ffffffffc02035a0 <kernel_thread>
ffffffffc020370e:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0203710:	0ea05963          	blez	a0,ffffffffc0203802 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID)
ffffffffc0203714:	6789                	lui	a5,0x2
ffffffffc0203716:	fff5071b          	addiw	a4,a0,-1
ffffffffc020371a:	17f9                	addi	a5,a5,-2
ffffffffc020371c:	2501                	sext.w	a0,a0
ffffffffc020371e:	02e7e363          	bltu	a5,a4,ffffffffc0203744 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0203722:	45a9                	li	a1,10
ffffffffc0203724:	282000ef          	jal	ra,ffffffffc02039a6 <hash32>
ffffffffc0203728:	02051793          	slli	a5,a0,0x20
ffffffffc020372c:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0203730:	96a6                	add	a3,a3,s1
ffffffffc0203732:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0203734:	a029                	j	ffffffffc020373e <proc_init+0x132>
            if (proc->pid == pid)
ffffffffc0203736:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc020373a:	0a870563          	beq	a4,s0,ffffffffc02037e4 <proc_init+0x1d8>
    return listelm->next;
ffffffffc020373e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203740:	fef69be3          	bne	a3,a5,ffffffffc0203736 <proc_init+0x12a>
    return NULL;
ffffffffc0203744:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203746:	0b478493          	addi	s1,a5,180
ffffffffc020374a:	4641                	li	a2,16
...
ffffffffc020374e:	0000a417          	auipc	s0,0xa
ffffffffc0203752:	d9240413          	addi	s0,s0,-622 # ffffffffc020d4e0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203756:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0203758:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020375a:	6f2000ef          	jal	ra,ffffffffc0203e4c <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020375e:	463d                	li	a2,15
ffffffffc0203760:	00002597          	auipc	a1,0x2
ffffffffc0203764:	f9858593          	addi	a1,a1,-104 # ffffffffc02056f8 <default_pmm_manager+0xa28>
ffffffffc0203768:	8526                	mv	a0,s1
ffffffffc020376a:	6f4000ef          	jal	ra,ffffffffc0203e5e <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020376e:	00093783          	ld	a5,0(s2)
ffffffffc0203772:	c7e1                	beqz	a5,ffffffffc020383a <proc_init+0x22e>
ffffffffc0203774:	43dc                	lw	a5,4(a5)
ffffffffc0203776:	e3f1                	bnez	a5,ffffffffc020383a <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0203778:	601c                	ld	a5,0(s0)
ffffffffc020377a:	c3c5                	beqz	a5,ffffffffc020381a <proc_init+0x20e>
ffffffffc020377c:	43d8                	lw	a4,4(a5)
ffffffffc020377e:	4785                	li	a5,1
ffffffffc0203780:	08f71d63          	bne	a4,a5,ffffffffc020381a <proc_init+0x20e>
}
...
ffffffffc0203794:	ff09                	bnez	a4,ffffffffc02036ae <proc_init+0xa2>
ffffffffc0203796:	f0099ce3          	bnez	s3,ffffffffc02036ae <proc_init+0xa2>
ffffffffc020379a:	6394                	ld	a3,0(a5)
ffffffffc020379c:	577d                	li	a4,-1
ffffffffc020379e:	1702                	slli	a4,a4,0x20
ffffffffc02037a0:	f0e697e3          	bne	a3,a4,ffffffffc02036ae <proc_init+0xa2>
ffffffffc02037a4:	4798                	lw	a4,8(a5)
ffffffffc02037a6:	f00714e3          	bnez	a4,ffffffffc02036ae <proc_init+0xa2>
ffffffffc02037aa:	6b98                	ld	a4,16(a5)
ffffffffc02037ac:	f00711e3          	bnez	a4,ffffffffc02036ae <proc_init+0xa2>
ffffffffc02037b0:	4f98                	lw	a4,24(a5)
ffffffffc02037b2:	2701                	sext.w	a4,a4
ffffffffc02037b4:	ee071de3          	bnez	a4,ffffffffc02036ae <proc_init+0xa2>
ffffffffc02037b8:	7398                	ld	a4,32(a5)
ffffffffc02037ba:	ee071ae3          	bnez	a4,ffffffffc02036ae <proc_init+0xa2>
ffffffffc02037be:	7798                	ld	a4,40(a5)
ffffffffc02037c0:	ee0717e3          	bnez	a4,ffffffffc02036ae <proc_init+0xa2>
ffffffffc02037c4:	0b07a703          	lw	a4,176(a5)
ffffffffc02037c8:	8d59                	or	a0,a0,a4
ffffffffc02037ca:	0005071b          	sext.w	a4,a0
ffffffffc02037ce:	ee0710e3          	bnez	a4,ffffffffc02036ae <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02037d2:	00002517          	auipc	a0,0x2
ffffffffc02037d6:	ed650513          	addi	a0,a0,-298 # ffffffffc02056a8 <default_pmm_manager+0x9d8>
ffffffffc02037da:	9bbfc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    idleproc->pid = 0;
ffffffffc02037de:	00093783          	ld	a5,0(s2)
ffffffffc02037e2:	b5f1                	j	ffffffffc02036ae <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02037e4:	f2878793          	addi	a5,a5,-216
ffffffffc02037e8:	bfb9                	j	ffffffffc0203746 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02037ea:	00002617          	auipc	a2,0x2
ffffffffc02037ee:	ea660613          	addi	a2,a2,-346 # ffffffffc0205690 <default_pmm_manager+0x9c0>
ffffffffc02037f2:	1b100593          	li	a1,433
ffffffffc02037f6:	00002517          	auipc	a0,0x2
ffffffffc02037fa:	e6a50513          	addi	a0,a0,-406 # ffffffffc0205660 <default_pmm_manager+0x990>
ffffffffc02037fe:	c5dfc0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("create init_main failed.\n");
ffffffffc0203802:	00002617          	auipc	a2,0x2
ffffffffc0203806:	ed660613          	addi	a2,a2,-298 # ffffffffc02056d8 <default_pmm_manager+0xa08>
ffffffffc020380a:	1ce00593          	li	a1,462
ffffffffc020380e:	00002517          	auipc	a0,0x2
ffffffffc0203812:	e5250513          	addi	a0,a0,-430 # ffffffffc0205660 <default_pmm_manager+0x990>
ffffffffc0203816:	c45fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020381a:	00002697          	auipc	a3,0x2
ffffffffc020381e:	f0e68693          	addi	a3,a3,-242 # ffffffffc0205728 <default_pmm_manager+0xa58>
ffffffffc0203822:	00001617          	auipc	a2,0x1
ffffffffc0203826:	0fe60613          	addi	a2,a2,254 # ffffffffc0204920 <commands+0x818>
ffffffffc020382a:	1d500593          	li	a1,469
ffffffffc020382e:	00002517          	auipc	a0,0x2
ffffffffc0203832:	e3250513          	addi	a0,a0,-462 # ffffffffc0205660 <default_pmm_manager+0x990>
ffffffffc0203836:	c25fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020383a:	00002697          	auipc	a3,0x2
ffffffffc020383e:	ec668693          	addi	a3,a3,-314 # ffffffffc0205700 <default_pmm_manager+0xa30>
ffffffffc0203842:	00001617          	auipc	a2,0x1
ffffffffc0203846:	0de60613          	addi	a2,a2,222 # ffffffffc0204920 <commands+0x818>
ffffffffc020384a:	1d400593          	li	a1,468
ffffffffc020384e:	00002517          	auipc	a0,0x2
ffffffffc0203852:	e1250513          	addi	a0,a0,-494 # ffffffffc0205660 <default_pmm_manager+0x990>
ffffffffc0203856:	c05fc0ef          	jal	ra,ffffffffc020045a <__panic>
...
ffffffffc0203864:	c7040413          	addi	s0,s0,-912 # ffffffffc020d4d0 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc0203868:	6018                	ld	a4,0(s0)
ffffffffc020386a:	4f1c                	lw	a5,24(a4)
ffffffffc020386c:	2781                	sext.w	a5,a5
ffffffffc020386e:	dff5                	beqz	a5,ffffffffc020386a <cpu_idle+0x10>
        {
            schedule();
ffffffffc0203870:	0a2000ef          	jal	ra,ffffffffc0203912 <schedule>
ffffffffc0203874:	bfd5                	j	ffffffffc0203868 <cpu_idle+0xe>
...
ffffffffc02038f6:	e5e68693          	addi	a3,a3,-418 # ffffffffc0205750 <default_pmm_manager+0xa80>
ffffffffc02038fa:	00001617          	auipc	a2,0x1
ffffffffc02038fe:	02660613          	addi	a2,a2,38 # ffffffffc0204920 <commands+0x818>
ffffffffc0203902:	45a5                	li	a1,9
ffffffffc0203904:	00002517          	auipc	a0,0x2
ffffffffc0203908:	e8c50513          	addi	a0,a0,-372 # ffffffffc0205790 <default_pmm_manager+0xac0>
wakeup_proc(struct proc_struct *proc) {
ffffffffc020390c:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020390e:	b4dfc0ef          	jal	ra,ffffffffc020045a <__panic>
...
ffffffffc0203916:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203918:	100027f3          	csrr	a5,sstatus
ffffffffc020391c:	8b89                	andi	a5,a5,2
ffffffffc020391e:	4401                	li	s0,0
ffffffffc0203920:	efbd                	bnez	a5,ffffffffc020399e <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0203922:	0000a897          	auipc	a7,0xa
ffffffffc0203926:	bae8b883          	ld	a7,-1106(a7) # ffffffffc020d4d0 <current>
ffffffffc020392a:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020392e:	0000a517          	auipc	a0,0xa
ffffffffc0203932:	baa53503          	ld	a0,-1110(a0) # ffffffffc020d4d8 <idleproc>
ffffffffc0203936:	04a88e63          	beq	a7,a0,ffffffffc0203992 <schedule+0x80>
ffffffffc020393a:	0c888693          	addi	a3,a7,200
ffffffffc020393e:	0000a617          	auipc	a2,0xa
ffffffffc0203942:	b1a60613          	addi	a2,a2,-1254 # ffffffffc020d458 <proc_list>
        le = last;
ffffffffc0203946:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc020394a:	4809                	li	a6,2
ffffffffc020394c:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc020394e:	00c78863          	beq	a5,a2,ffffffffc020395e <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0203952:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0203956:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc020395a:	03070163          	beq	a4,a6,ffffffffc020397c <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc020395e:	fef697e3          	bne	a3,a5,ffffffffc020394c <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0203962:	ed89                	bnez	a1,ffffffffc020397c <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0203964:	451c                	lw	a5,8(a0)
ffffffffc0203966:	2785                	addiw	a5,a5,1
ffffffffc0203968:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc020396a:	00a88463          	beq	a7,a0,ffffffffc0203972 <schedule+0x60>
            proc_run(next);
ffffffffc020396e:	98dff0ef          	jal	ra,ffffffffc02032fa <proc_run>
    if (flag) {
ffffffffc0203972:	e819                	bnez	s0,ffffffffc0203988 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0203974:	60a2                	ld	ra,8(sp)
ffffffffc0203976:	6402                	ld	s0,0(sp)
ffffffffc0203978:	0141                	addi	sp,sp,16
ffffffffc020397a:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020397c:	4198                	lw	a4,0(a1)
ffffffffc020397e:	4789                	li	a5,2
ffffffffc0203980:	fef712e3          	bne	a4,a5,ffffffffc0203964 <schedule+0x52>
ffffffffc0203984:	852e                	mv	a0,a1
ffffffffc0203986:	bff9                	j	ffffffffc0203964 <schedule+0x52>
}
ffffffffc0203988:	6402                	ld	s0,0(sp)
ffffffffc020398a:	60a2                	ld	ra,8(sp)
ffffffffc020398c:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020398e:	f9dfc06f          	j	ffffffffc020092a <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
...
ffffffffc020399c:	b76d                	j	ffffffffc0203946 <schedule+0x34>
        intr_disable();
ffffffffc020399e:	f93fc0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc02039a2:	4405                	li	s0,1
ffffffffc02039a4:	bfbd                	j	ffffffffc0203922 <schedule+0x10>
...
ffffffffc02039aa:	2785                	addiw	a5,a5,1
ffffffffc02039ac:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02039b0:	02000793          	li	a5,32
ffffffffc02039b4:	9f8d                	subw	a5,a5,a1
}
ffffffffc02039b6:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc02039bc:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039c0:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02039c2:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039c6:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02039c8:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039cc:	f022                	sd	s0,32(sp)
ffffffffc02039ce:	ec26                	sd	s1,24(sp)
ffffffffc02039d0:	e84a                	sd	s2,16(sp)
ffffffffc02039d2:	f406                	sd	ra,40(sp)
ffffffffc02039d4:	e44e                	sd	s3,8(sp)
...
ffffffffc02039d8:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc02039da:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02039de:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc02039e0:	03067e63          	bgeu	a2,a6,ffffffffc0203a1c <printnum+0x60>
ffffffffc02039e4:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc02039e6:	00805763          	blez	s0,ffffffffc02039f4 <printnum+0x38>
ffffffffc02039ea:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02039ec:	85ca                	mv	a1,s2
ffffffffc02039ee:	854e                	mv	a0,s3
...
ffffffffc02039f4:	1a02                	slli	s4,s4,0x20
ffffffffc02039f6:	00002797          	auipc	a5,0x2
ffffffffc02039fa:	db278793          	addi	a5,a5,-590 # ffffffffc02057a8 <default_pmm_manager+0xad8>
ffffffffc02039fe:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203a02:	9a3e                	add	s4,s4,a5
}
ffffffffc0203a04:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a06:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203a0a:	70a2                	ld	ra,40(sp)
ffffffffc0203a0c:	69a2                	ld	s3,8(sp)
ffffffffc0203a0e:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a10:	85ca                	mv	a1,s2
ffffffffc0203a12:	87a6                	mv	a5,s1
}
ffffffffc0203a14:	6942                	ld	s2,16(sp)
ffffffffc0203a16:	64e2                	ld	s1,24(sp)
ffffffffc0203a18:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a1a:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203a1c:	03065633          	divu	a2,a2,a6
ffffffffc0203a20:	8722                	mv	a4,s0
ffffffffc0203a22:	f9bff0ef          	jal	ra,ffffffffc02039bc <printnum>
ffffffffc0203a26:	b7f9                	j	ffffffffc02039f4 <printnum+0x38>

ffffffffc0203a28 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203a28:	7119                	addi	sp,sp,-128
ffffffffc0203a2a:	f4a6                	sd	s1,104(sp)
ffffffffc0203a2c:	f0ca                	sd	s2,96(sp)
ffffffffc0203a2e:	ecce                	sd	s3,88(sp)
ffffffffc0203a30:	e8d2                	sd	s4,80(sp)
ffffffffc0203a32:	e4d6                	sd	s5,72(sp)
ffffffffc0203a34:	e0da                	sd	s6,64(sp)
ffffffffc0203a36:	fc5e                	sd	s7,56(sp)
ffffffffc0203a38:	f06a                	sd	s10,32(sp)
ffffffffc0203a3a:	fc86                	sd	ra,120(sp)
ffffffffc0203a3c:	f8a2                	sd	s0,112(sp)
ffffffffc0203a3e:	f862                	sd	s8,48(sp)
ffffffffc0203a40:	f466                	sd	s9,40(sp)
ffffffffc0203a42:	ec6e                	sd	s11,24(sp)
ffffffffc0203a44:	892a                	mv	s2,a0
ffffffffc0203a46:	84ae                	mv	s1,a1
ffffffffc0203a48:	8d32                	mv	s10,a2
ffffffffc0203a4a:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203a4c:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203a50:	5b7d                	li	s6,-1
ffffffffc0203a52:	00002a97          	auipc	s5,0x2
ffffffffc0203a56:	d82a8a93          	addi	s5,s5,-638 # ffffffffc02057d4 <default_pmm_manager+0xb04>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203a5a:	00002b97          	auipc	s7,0x2
ffffffffc0203a5e:	f56b8b93          	addi	s7,s7,-170 # ffffffffc02059b0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a62:	000d4503          	lbu	a0,0(s10)
ffffffffc0203a66:	001d0413          	addi	s0,s10,1
ffffffffc0203a6a:	01350a63          	beq	a0,s3,ffffffffc0203a7e <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203a6e:	c121                	beqz	a0,ffffffffc0203aae <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203a70:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a72:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203a74:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a76:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203a7a:	ff351ae3          	bne	a0,s3,ffffffffc0203a6e <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a7e:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203a82:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203a86:	4c81                	li	s9,0
ffffffffc0203a88:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203a8a:	5c7d                	li	s8,-1
ffffffffc0203a8c:	5dfd                	li	s11,-1
ffffffffc0203a8e:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203a92:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a94:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203a98:	0ff5f593          	zext.b	a1,a1
ffffffffc0203a9c:	00140d13          	addi	s10,s0,1
ffffffffc0203aa0:	04b56263          	bltu	a0,a1,ffffffffc0203ae4 <vprintfmt+0xbc>
ffffffffc0203aa4:	058a                	slli	a1,a1,0x2
ffffffffc0203aa6:	95d6                	add	a1,a1,s5
ffffffffc0203aa8:	4194                	lw	a3,0(a1)
ffffffffc0203aaa:	96d6                	add	a3,a3,s5
ffffffffc0203aac:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203aae:	70e6                	ld	ra,120(sp)
ffffffffc0203ab0:	7446                	ld	s0,112(sp)
ffffffffc0203ab2:	74a6                	ld	s1,104(sp)
ffffffffc0203ab4:	7906                	ld	s2,96(sp)
ffffffffc0203ab6:	69e6                	ld	s3,88(sp)
ffffffffc0203ab8:	6a46                	ld	s4,80(sp)
ffffffffc0203aba:	6aa6                	ld	s5,72(sp)
ffffffffc0203abc:	6b06                	ld	s6,64(sp)
ffffffffc0203abe:	7be2                	ld	s7,56(sp)
ffffffffc0203ac0:	7c42                	ld	s8,48(sp)
ffffffffc0203ac2:	7ca2                	ld	s9,40(sp)
ffffffffc0203ac4:	7d02                	ld	s10,32(sp)
ffffffffc0203ac6:	6de2                	ld	s11,24(sp)
ffffffffc0203ac8:	6109                	addi	sp,sp,128
ffffffffc0203aca:	8082                	ret
            padc = '0';
ffffffffc0203acc:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203ace:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ad2:	846a                	mv	s0,s10
ffffffffc0203ad4:	00140d13          	addi	s10,s0,1
ffffffffc0203ad8:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203adc:	0ff5f593          	zext.b	a1,a1
ffffffffc0203ae0:	fcb572e3          	bgeu	a0,a1,ffffffffc0203aa4 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203ae4:	85a6                	mv	a1,s1
ffffffffc0203ae6:	02500513          	li	a0,37
ffffffffc0203aea:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203aec:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203af0:	8d22                	mv	s10,s0
ffffffffc0203af2:	f73788e3          	beq	a5,s3,ffffffffc0203a62 <vprintfmt+0x3a>
ffffffffc0203af6:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203afa:	1d7d                	addi	s10,s10,-1
ffffffffc0203afc:	ff379de3          	bne	a5,s3,ffffffffc0203af6 <vprintfmt+0xce>
ffffffffc0203b00:	b78d                	j	ffffffffc0203a62 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203b02:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203b06:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b0a:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203b0c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203b10:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b14:	02d86463          	bltu	a6,a3,ffffffffc0203b3c <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203b18:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203b1c:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203b20:	0186873b          	addw	a4,a3,s8
ffffffffc0203b24:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203b28:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203b2a:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203b2e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203b30:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203b34:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b38:	fed870e3          	bgeu	a6,a3,ffffffffc0203b18 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203b3c:	f40ddce3          	bgez	s11,ffffffffc0203a94 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203b40:	8de2                	mv	s11,s8
ffffffffc0203b42:	5c7d                	li	s8,-1
ffffffffc0203b44:	bf81                	j	ffffffffc0203a94 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203b46:	fffdc693          	not	a3,s11
ffffffffc0203b4a:	96fd                	srai	a3,a3,0x3f
ffffffffc0203b4c:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b50:	00144603          	lbu	a2,1(s0)
ffffffffc0203b54:	2d81                	sext.w	s11,s11
ffffffffc0203b56:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b58:	bf35                	j	ffffffffc0203a94 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203b5a:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b5e:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203b62:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b64:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203b66:	bfd9                	j	ffffffffc0203b3c <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203b68:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b6a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b6e:	01174463          	blt	a4,a7,ffffffffc0203b76 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203b72:	1a088e63          	beqz	a7,ffffffffc0203d2e <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203b76:	000a3603          	ld	a2,0(s4)
ffffffffc0203b7a:	46c1                	li	a3,16
ffffffffc0203b7c:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203b7e:	2781                	sext.w	a5,a5
ffffffffc0203b80:	876e                	mv	a4,s11
ffffffffc0203b82:	85a6                	mv	a1,s1
ffffffffc0203b84:	854a                	mv	a0,s2
ffffffffc0203b86:	e37ff0ef          	jal	ra,ffffffffc02039bc <printnum>
            break;
ffffffffc0203b8a:	bde1                	j	ffffffffc0203a62 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0203b8c:	000a2503          	lw	a0,0(s4)
ffffffffc0203b90:	85a6                	mv	a1,s1
ffffffffc0203b92:	0a21                	addi	s4,s4,8
ffffffffc0203b94:	9902                	jalr	s2
            break;
ffffffffc0203b96:	b5f1                	j	ffffffffc0203a62 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203b98:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b9a:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b9e:	01174463          	blt	a4,a7,ffffffffc0203ba6 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0203ba2:	18088163          	beqz	a7,ffffffffc0203d24 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0203ba6:	000a3603          	ld	a2,0(s4)
ffffffffc0203baa:	46a9                	li	a3,10
ffffffffc0203bac:	8a2e                	mv	s4,a1
ffffffffc0203bae:	bfc1                	j	ffffffffc0203b7e <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bb0:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203bb4:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bb6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bb8:	bdf1                	j	ffffffffc0203a94 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0203bba:	85a6                	mv	a1,s1
ffffffffc0203bbc:	02500513          	li	a0,37
ffffffffc0203bc0:	9902                	jalr	s2
            break;
ffffffffc0203bc2:	b545                	j	ffffffffc0203a62 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bc4:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0203bc8:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bca:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bcc:	b5e1                	j	ffffffffc0203a94 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0203bce:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bd0:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203bd4:	01174463          	blt	a4,a7,ffffffffc0203bdc <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0203bd8:	14088163          	beqz	a7,ffffffffc0203d1a <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0203bdc:	000a3603          	ld	a2,0(s4)
ffffffffc0203be0:	46a1                	li	a3,8
ffffffffc0203be2:	8a2e                	mv	s4,a1
ffffffffc0203be4:	bf69                	j	ffffffffc0203b7e <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0203be6:	03000513          	li	a0,48
ffffffffc0203bea:	85a6                	mv	a1,s1
ffffffffc0203bec:	e03e                	sd	a5,0(sp)
ffffffffc0203bee:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203bf0:	85a6                	mv	a1,s1
ffffffffc0203bf2:	07800513          	li	a0,120
ffffffffc0203bf6:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203bf8:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0203bfa:	6782                	ld	a5,0(sp)
ffffffffc0203bfc:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203bfe:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0203c02:	bfb5                	j	ffffffffc0203b7e <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c04:	000a3403          	ld	s0,0(s4)
ffffffffc0203c08:	008a0713          	addi	a4,s4,8
ffffffffc0203c0c:	e03a                	sd	a4,0(sp)
ffffffffc0203c0e:	14040263          	beqz	s0,ffffffffc0203d52 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0203c12:	0fb05763          	blez	s11,ffffffffc0203d00 <vprintfmt+0x2d8>
ffffffffc0203c16:	02d00693          	li	a3,45
ffffffffc0203c1a:	0cd79163          	bne	a5,a3,ffffffffc0203cdc <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c1e:	00044783          	lbu	a5,0(s0)
ffffffffc0203c22:	0007851b          	sext.w	a0,a5
ffffffffc0203c26:	cf85                	beqz	a5,ffffffffc0203c5e <vprintfmt+0x236>
ffffffffc0203c28:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c2c:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c30:	000c4563          	bltz	s8,ffffffffc0203c3a <vprintfmt+0x212>
ffffffffc0203c34:	3c7d                	addiw	s8,s8,-1
ffffffffc0203c36:	036c0263          	beq	s8,s6,ffffffffc0203c5a <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0203c3a:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c3c:	0e0c8e63          	beqz	s9,ffffffffc0203d38 <vprintfmt+0x310>
ffffffffc0203c40:	3781                	addiw	a5,a5,-32
ffffffffc0203c42:	0ef47b63          	bgeu	s0,a5,ffffffffc0203d38 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0203c46:	03f00513          	li	a0,63
ffffffffc0203c4a:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c4c:	000a4783          	lbu	a5,0(s4)
ffffffffc0203c50:	3dfd                	addiw	s11,s11,-1
ffffffffc0203c52:	0a05                	addi	s4,s4,1
ffffffffc0203c54:	0007851b          	sext.w	a0,a5
ffffffffc0203c58:	ffe1                	bnez	a5,ffffffffc0203c30 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0203c5a:	01b05963          	blez	s11,ffffffffc0203c6c <vprintfmt+0x244>
ffffffffc0203c5e:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203c60:	85a6                	mv	a1,s1
ffffffffc0203c62:	02000513          	li	a0,32
ffffffffc0203c66:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203c68:	fe0d9be3          	bnez	s11,ffffffffc0203c5e <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c6c:	6a02                	ld	s4,0(sp)
ffffffffc0203c6e:	bbd5                	j	ffffffffc0203a62 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203c70:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203c72:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0203c76:	01174463          	blt	a4,a7,ffffffffc0203c7e <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0203c7a:	08088d63          	beqz	a7,ffffffffc0203d14 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0203c7e:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0203c82:	0a044d63          	bltz	s0,ffffffffc0203d3c <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0203c86:	8622                	mv	a2,s0
ffffffffc0203c88:	8a66                	mv	s4,s9
ffffffffc0203c8a:	46a9                	li	a3,10
ffffffffc0203c8c:	bdcd                	j	ffffffffc0203b7e <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0203c8e:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203c92:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203c94:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0203c96:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203c9a:	8fb5                	xor	a5,a5,a3
ffffffffc0203c9c:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ca0:	02d74163          	blt	a4,a3,ffffffffc0203cc2 <vprintfmt+0x29a>
ffffffffc0203ca4:	00369793          	slli	a5,a3,0x3
ffffffffc0203ca8:	97de                	add	a5,a5,s7
ffffffffc0203caa:	639c                	ld	a5,0(a5)
ffffffffc0203cac:	cb99                	beqz	a5,ffffffffc0203cc2 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203cae:	86be                	mv	a3,a5
ffffffffc0203cb0:	00000617          	auipc	a2,0x0
ffffffffc0203cb4:	21860613          	addi	a2,a2,536 # ffffffffc0203ec8 <etext+0x2e>
ffffffffc0203cb8:	85a6                	mv	a1,s1
ffffffffc0203cba:	854a                	mv	a0,s2
ffffffffc0203cbc:	0ce000ef          	jal	ra,ffffffffc0203d8a <printfmt>
ffffffffc0203cc0:	b34d                	j	ffffffffc0203a62 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0203cc2:	00002617          	auipc	a2,0x2
ffffffffc0203cc6:	b0660613          	addi	a2,a2,-1274 # ffffffffc02057c8 <default_pmm_manager+0xaf8>
ffffffffc0203cca:	85a6                	mv	a1,s1
ffffffffc0203ccc:	854a                	mv	a0,s2
ffffffffc0203cce:	0bc000ef          	jal	ra,ffffffffc0203d8a <printfmt>
ffffffffc0203cd2:	bb41                	j	ffffffffc0203a62 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0203cd4:	00002417          	auipc	s0,0x2
ffffffffc0203cd8:	aec40413          	addi	s0,s0,-1300 # ffffffffc02057c0 <default_pmm_manager+0xaf0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cdc:	85e2                	mv	a1,s8
ffffffffc0203cde:	8522                	mv	a0,s0
ffffffffc0203ce0:	e43e                	sd	a5,8(sp)
ffffffffc0203ce2:	0e2000ef          	jal	ra,ffffffffc0203dc4 <strnlen>
ffffffffc0203ce6:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0203cea:	01b05b63          	blez	s11,ffffffffc0203d00 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0203cee:	67a2                	ld	a5,8(sp)
ffffffffc0203cf0:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cf4:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0203cf6:	85a6                	mv	a1,s1
ffffffffc0203cf8:	8552                	mv	a0,s4
ffffffffc0203cfa:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cfc:	fe0d9ce3          	bnez	s11,ffffffffc0203cf4 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203d00:	00044783          	lbu	a5,0(s0)
ffffffffc0203d04:	00140a13          	addi	s4,s0,1
ffffffffc0203d08:	0007851b          	sext.w	a0,a5
ffffffffc0203d0c:	d3a5                	beqz	a5,ffffffffc0203c6c <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d0e:	05e00413          	li	s0,94
ffffffffc0203d12:	bf39                	j	ffffffffc0203c30 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0203d14:	000a2403          	lw	s0,0(s4)
ffffffffc0203d18:	b7ad                	j	ffffffffc0203c82 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0203d1a:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d1e:	46a1                	li	a3,8
ffffffffc0203d20:	8a2e                	mv	s4,a1
ffffffffc0203d22:	bdb1                	j	ffffffffc0203b7e <vprintfmt+0x156>
ffffffffc0203d24:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d28:	46a9                	li	a3,10
ffffffffc0203d2a:	8a2e                	mv	s4,a1
ffffffffc0203d2c:	bd89                	j	ffffffffc0203b7e <vprintfmt+0x156>
ffffffffc0203d2e:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d32:	46c1                	li	a3,16
ffffffffc0203d34:	8a2e                	mv	s4,a1
ffffffffc0203d36:	b5a1                	j	ffffffffc0203b7e <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0203d38:	9902                	jalr	s2
ffffffffc0203d3a:	bf09                	j	ffffffffc0203c4c <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0203d3c:	85a6                	mv	a1,s1
ffffffffc0203d3e:	02d00513          	li	a0,45
ffffffffc0203d42:	e03e                	sd	a5,0(sp)
ffffffffc0203d44:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0203d46:	6782                	ld	a5,0(sp)
ffffffffc0203d48:	8a66                	mv	s4,s9
ffffffffc0203d4a:	40800633          	neg	a2,s0
ffffffffc0203d4e:	46a9                	li	a3,10
ffffffffc0203d50:	b53d                	j	ffffffffc0203b7e <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0203d52:	03b05163          	blez	s11,ffffffffc0203d74 <vprintfmt+0x34c>
ffffffffc0203d56:	02d00693          	li	a3,45
ffffffffc0203d5a:	f6d79de3          	bne	a5,a3,ffffffffc0203cd4 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0203d5e:	00002417          	auipc	s0,0x2
ffffffffc0203d62:	a6240413          	addi	s0,s0,-1438 # ffffffffc02057c0 <default_pmm_manager+0xaf0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203d66:	02800793          	li	a5,40
ffffffffc0203d6a:	02800513          	li	a0,40
ffffffffc0203d6e:	00140a13          	addi	s4,s0,1
ffffffffc0203d72:	bd6d                	j	ffffffffc0203c2c <vprintfmt+0x204>
ffffffffc0203d74:	00002a17          	auipc	s4,0x2
ffffffffc0203d78:	a4da0a13          	addi	s4,s4,-1459 # ffffffffc02057c1 <default_pmm_manager+0xaf1>
ffffffffc0203d7c:	02800513          	li	a0,40
ffffffffc0203d80:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d84:	05e00413          	li	s0,94
ffffffffc0203d88:	b565                	j	ffffffffc0203c30 <vprintfmt+0x208>

ffffffffc0203d8a <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d8a:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0203d8c:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d90:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203d92:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d94:	ec06                	sd	ra,24(sp)
ffffffffc0203d96:	f83a                	sd	a4,48(sp)
ffffffffc0203d98:	fc3e                	sd	a5,56(sp)
ffffffffc0203d9a:	e0c2                	sd	a6,64(sp)
ffffffffc0203d9c:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0203d9e:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203da0:	c89ff0ef          	jal	ra,ffffffffc0203a28 <vprintfmt>
}
ffffffffc0203da4:	60e2                	ld	ra,24(sp)
ffffffffc0203da6:	6161                	addi	sp,sp,80
...
strlen(const char *s) {
ffffffffc0203dae:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0203db0:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0203db2:	cb81                	beqz	a5,ffffffffc0203dc2 <strlen+0x18>
        cnt ++;
ffffffffc0203db4:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0203db6:	00a707b3          	add	a5,a4,a0
ffffffffc0203dba:	0007c783          	lbu	a5,0(a5)
ffffffffc0203dbe:	fbfd                	bnez	a5,ffffffffc0203db4 <strlen+0xa>
...
ffffffffc0203dc4:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203dc6:	e589                	bnez	a1,ffffffffc0203dd0 <strnlen+0xc>
ffffffffc0203dc8:	a811                	j	ffffffffc0203ddc <strnlen+0x18>
        cnt ++;
ffffffffc0203dca:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203dcc:	00f58863          	beq	a1,a5,ffffffffc0203ddc <strnlen+0x18>
ffffffffc0203dd0:	00f50733          	add	a4,a0,a5
ffffffffc0203dd4:	00074703          	lbu	a4,0(a4)
ffffffffc0203dd8:	fb6d                	bnez	a4,ffffffffc0203dca <strnlen+0x6>
ffffffffc0203dda:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0203ddc:	852e                	mv	a0,a1
ffffffffc0203dde:	8082                	ret

ffffffffc0203de0 <strcpy>:
char *
...
ffffffffc0203de0:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0203de2:	0005c703          	lbu	a4,0(a1)
ffffffffc0203de6:	0785                	addi	a5,a5,1
ffffffffc0203de8:	0585                	addi	a1,a1,1
ffffffffc0203dea:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0203dee:	fb75                	bnez	a4,ffffffffc0203de2 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203df2:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203df6:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203dfa:	cb89                	beqz	a5,ffffffffc0203e0c <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0203dfc:	0505                	addi	a0,a0,1
ffffffffc0203dfe:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203e00:	fee789e3          	beq	a5,a4,ffffffffc0203df2 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e04:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0203e08:	9d19                	subw	a0,a0,a4
ffffffffc0203e0a:	8082                	ret
ffffffffc0203e0c:	4501                	li	a0,0
ffffffffc0203e0e:	bfed                	j	ffffffffc0203e08 <strcmp+0x16>

ffffffffc0203e10 <strncmp>:
...
ffffffffc0203e10:	c20d                	beqz	a2,ffffffffc0203e32 <strncmp+0x22>
ffffffffc0203e12:	962e                	add	a2,a2,a1
ffffffffc0203e14:	a031                	j	ffffffffc0203e20 <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0203e16:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e18:	00e79a63          	bne	a5,a4,ffffffffc0203e2c <strncmp+0x1c>
ffffffffc0203e1c:	00b60b63          	beq	a2,a1,ffffffffc0203e32 <strncmp+0x22>
ffffffffc0203e20:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0203e24:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e26:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0203e2a:	f7f5                	bnez	a5,ffffffffc0203e16 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e2c:	40e7853b          	subw	a0,a5,a4
}
...
ffffffffc0203e3a:	c799                	beqz	a5,ffffffffc0203e48 <strchr+0x12>
        if (*s == c) {
ffffffffc0203e3c:	00f58763          	beq	a1,a5,ffffffffc0203e4a <strchr+0x14>
    while (*s != '\0') {
ffffffffc0203e40:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0203e44:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0203e46:	fbfd                	bnez	a5,ffffffffc0203e3c <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0203e4c:	ca01                	beqz	a2,ffffffffc0203e5c <memset+0x10>
ffffffffc0203e4e:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0203e50:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0203e52:	0785                	addi	a5,a5,1
ffffffffc0203e54:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0203e58:	fec79de3          	bne	a5,a2,ffffffffc0203e52 <memset+0x6>
    }
    return s;
...
ffffffffc0203e5e <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0203e5e:	ca19                	beqz	a2,ffffffffc0203e74 <memcpy+0x16>
ffffffffc0203e60:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0203e62:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0203e64:	0005c703          	lbu	a4,0(a1)
ffffffffc0203e68:	0585                	addi	a1,a1,1
ffffffffc0203e6a:	0785                	addi	a5,a5,1
ffffffffc0203e6c:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0203e70:	fec59ae3          	bne	a1,a2,ffffffffc0203e64 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0203e76:	c205                	beqz	a2,ffffffffc0203e96 <memcmp+0x20>
ffffffffc0203e78:	962e                	add	a2,a2,a1
ffffffffc0203e7a:	a019                	j	ffffffffc0203e80 <memcmp+0xa>
ffffffffc0203e7c:	00c58d63          	beq	a1,a2,ffffffffc0203e96 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0203e80:	00054783          	lbu	a5,0(a0)
ffffffffc0203e84:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0203e88:	0505                	addi	a0,a0,1
ffffffffc0203e8a:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0203e8c:	fee788e3          	beq	a5,a4,ffffffffc0203e7c <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e90:	40e7853b          	subw	a0,a5,a4
