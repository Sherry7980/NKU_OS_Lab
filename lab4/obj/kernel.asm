...
ffffffffc0203216:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc0203218:	c129                	beqz	a0,ffffffffc020325a <alloc_proc+0x52>
...
ffffffffc020321e:	07000613          	li	a2,112
ffffffffc0203222:	4581                	li	a1,0
        proc->state = PROC_UNINIT;                  // 初始化进程状态为未初始化
ffffffffc0203224:	e11c                	sd	a5,0(a0)
        proc->runs = 0;                             // 初始化运行次数为0
...
ffffffffc0203242:	4641                	li	a2,16
        proc->tf = NULL;                            // 初始化陷阱帧为NULL
ffffffffc0203244:	0a043023          	sd	zero,160(s0)
        proc->pgdir = 0;                            // 初始化页目录表基址为0
ffffffffc0203248:	0a043423          	sd	zero,168(s0)
        proc->flags = 0;                            // 初始化进程标志为0
ffffffffc020324c:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN + 1);   // 初始化进程名称为空字符串
ffffffffc0203250:	4581                	li	a1,0
ffffffffc0203252:	0b440513          	addi	a0,s0,180
ffffffffc0203256:	3e1000ef          	jal	ra,ffffffffc0203e36 <memset>
    }
    return proc;
}
...
ffffffffc020326e:	b63fd06f          	j	ffffffffc0200dd0 <forkrets>
...
ffffffffc02032c0:	34450513          	addi	a0,a0,836 # ffffffffc0205600 <default_pmm_manager+0x948>
ffffffffc02032c4:	ed1fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02032c8:	00002517          	auipc	a0,0x2
ffffffffc02032cc:	34850513          	addi	a0,a0,840 # ffffffffc0205610 <default_pmm_manager+0x958>
...
ffffffffc02032f4:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc02032f6:	02a70b63          	beq	a4,a0,ffffffffc020332c <proc_run+0x48>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0203300:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203302:	e3a1                	bnez	a5,ffffffffc0203342 <proc_run+0x5e>
        current->runs++;
...
ffffffffc0203324:	53c000ef          	jal	ra,ffffffffc0203860 <switch_to>
    if (flag) {
ffffffffc0203328:	00091763          	bnez	s2,ffffffffc0203336 <proc_run+0x52>
}
...
ffffffffc020334e:	bf5d                	j	ffffffffc0203304 <proc_run+0x20>
...
ffffffffc020341e:	e4a70713          	addi	a4,a4,-438 # ffffffffc0203264 <forkret>
    if (++last_pid >= MAX_PID)
...
ffffffffc020342a:	02d9bc23          	sd	a3,56(s3)
    if (++last_pid >= MAX_PID)
ffffffffc020342e:	00a82023          	sw	a0,0(a6)
ffffffffc0203432:	6789                	lui	a5,0x2
ffffffffc0203434:	08f55063          	bge	a0,a5,ffffffffc02034b4 <do_fork+0x164>
    if (last_pid >= next_safe)
ffffffffc0203438:	00006e17          	auipc	t3,0x6
ffffffffc020343c:	bf4e0e13          	addi	t3,t3,-1036 # ffffffffc020902c <next_safe.0>
ffffffffc0203440:	000e2783          	lw	a5,0(t3)
ffffffffc0203444:	0000a417          	auipc	s0,0xa
ffffffffc0203448:	01440413          	addi	s0,s0,20 # ffffffffc020d458 <proc_list>
ffffffffc020344c:	06f55c63          	bge	a0,a5,ffffffffc02034c4 <do_fork+0x174>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203450:	45a9                	li	a1,10
    proc->pid    = get_pid();
ffffffffc0203452:	00a9a223          	sw	a0,4(s3)
    proc->parent = current;
ffffffffc0203456:	0269b023          	sd	t1,32(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
...
ffffffffc02034bc:	00006e17          	auipc	t3,0x6
ffffffffc02034c0:	b70e0e13          	addi	t3,t3,-1168 # ffffffffc020902c <next_safe.0>
    return listelm->next;
ffffffffc02034c4:	0000a417          	auipc	s0,0xa
ffffffffc02034c8:	f9440413          	addi	s0,s0,-108 # ffffffffc020d458 <proc_list>
ffffffffc02034cc:	00843e83          	ld	t4,8(s0)
        next_safe = MAX_PID;
...
ffffffffc02034d8:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc02034da:	6f09                	lui	t5,0x2
ffffffffc02034dc:	048e8a63          	beq	t4,s0,ffffffffc0203530 <do_fork+0x1e0>
ffffffffc02034e0:	88ae                	mv	a7,a1
ffffffffc02034e2:	87f6                	mv	a5,t4
...
ffffffffc0203518:	f2088ce3          	beqz	a7,ffffffffc0203450 <do_fork+0x100>
ffffffffc020351c:	00ce2023          	sw	a2,0(t3)
ffffffffc0203520:	bf05                	j	ffffffffc0203450 <do_fork+0x100>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203522:	8936                	mv	s2,a3
ffffffffc0203524:	b5dd                	j	ffffffffc020340a <do_fork+0xba>
                    if (last_pid >= MAX_PID)
ffffffffc0203526:	01e6c363          	blt	a3,t5,ffffffffc020352c <do_fork+0x1dc>
                        last_pid = 1;
...
ffffffffc0203538:	bf21                	j	ffffffffc0203450 <do_fork+0x100>
    kfree(proc);
...
ffffffffc020354c:	b711                	j	ffffffffc0203450 <do_fork+0x100>
    ret = -E_NO_MEM;
...
ffffffffc0203562:	12300593          	li	a1,291
...
ffffffffc02035e4:	19300593          	li	a1,403
...
ffffffffc02036e6:	b9050513          	addi	a0,a0,-1136 # ffffffffc0203272 <init_main>
    nr_process++;
...
ffffffffc02037dc:	1ae00593          	li	a1,430
...
ffffffffc02037f4:	1cb00593          	li	a1,459
...
ffffffffc0203814:	1d200593          	li	a1,466
...
ffffffffc0203834:	1d100593          	li	a1,465
...
ffffffffc0203954:	00a88463          	beq	a7,a0,ffffffffc020395c <schedule+0x60>
            proc_run(next);
ffffffffc0203958:	98dff0ef          	jal	ra,ffffffffc02032e4 <proc_run>
    if (flag) {
