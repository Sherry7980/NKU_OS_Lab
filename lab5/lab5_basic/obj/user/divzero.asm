...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	54a50513          	addi	a0,a0,1354 # 800580 <main+0x36>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	54a50513          	addi	a0,a0,1354 # 8005a0 <main+0x56>
...
exit(int error_code) {
  ...
  80012a:	48250513          	addi	a0,a0,1154 # 8005a8 <main+0x5e>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	44678793          	addi	a5,a5,1094 # 8005c0 <main+0x76>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001da:	41ea8a93          	addi	s5,s5,1054 # 8005f4 <main+0xaa>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001e2:	632b8b93          	addi	s7,s7,1586 # 800810 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800438:	1bc60613          	addi	a2,a2,444 # 8005f0 <main+0xa6>
  ...
  80044a:	19a60613          	addi	a2,a2,410 # 8005e0 <main+0x96>
  ...
  80045c:	18040413          	addi	s0,s0,384 # 8005d8 <main+0x8e>
  ...
  8004e6:	0f640413          	addi	s0,s0,246 # 8005d8 <main+0x8e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004fc:	0e1a0a13          	addi	s4,s4,225 # 8005d9 <main+0x8f>
...
main(void) {
  800562:	e406                	sd	ra,8(sp)
    cprintf("value is %d.\n", 1 / zero);
  800564:	b3fff0ef          	jal	ra,8000a2 <cprintf>
    panic("FAIL: T.T\n");
  ...
  80057a:	aadff0ef          	jal	ra,800026 <__panic>
