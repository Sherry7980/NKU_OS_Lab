...
exit(int error_code) {
  ...
  8000d0:	45c50513          	addi	a0,a0,1116 # 800528 <main+0x34>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800128:	41c78793          	addi	a5,a5,1052 # 800540 <main+0x4c>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800184:	3f4a8a93          	addi	s5,s5,1012 # 800574 <main+0x80>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  80018c:	608b8b93          	addi	s7,s7,1544 # 800790 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e2:	19260613          	addi	a2,a2,402 # 800570 <main+0x7c>
  ...
  8003f4:	17060613          	addi	a2,a2,368 # 800560 <main+0x6c>
  ...
  800406:	15640413          	addi	s0,s0,342 # 800558 <main+0x64>
  ...
  800490:	0cc40413          	addi	s0,s0,204 # 800558 <main+0x64>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004a6:	0b7a0a13          	addi	s4,s4,183 # 800559 <main+0x65>
...
main(void) {
  ...
  8004f8:	be3ff0ef          	jal	ra,8000da <getpid>
  ...
  800506:	b3bff0ef          	jal	ra,800040 <cprintf>
    print_pgdir();
  80050a:	bd3ff0ef          	jal	ra,8000dc <print_pgdir>
    cprintf("pgdir pass.\n");
