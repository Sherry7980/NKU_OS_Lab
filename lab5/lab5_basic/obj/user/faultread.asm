...
exit(int error_code) {
  ...
  8000c8:	42c50513          	addi	a0,a0,1068 # 8004f0 <main+0x8>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80011c:	3f078793          	addi	a5,a5,1008 # 800508 <main+0x20>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800178:	3c8a8a93          	addi	s5,s5,968 # 80053c <main+0x54>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800180:	5dcb8b93          	addi	s7,s7,1500 # 800758 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003d6:	16660613          	addi	a2,a2,358 # 800538 <main+0x50>
  ...
  8003e8:	14460613          	addi	a2,a2,324 # 800528 <main+0x40>
  ...
  8003fa:	12a40413          	addi	s0,s0,298 # 800520 <main+0x38>
  ...
  800484:	0a040413          	addi	s0,s0,160 # 800520 <main+0x38>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  80049a:	08ba0a13          	addi	s4,s4,139 # 800521 <main+0x39>
...
main(void) {
  ...
  8004e8:	00002783          	lw	a5,0(zero) # 0 <_start-0x800020>
  8004ec:	9002                	ebreak
