...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	54250513          	addi	a0,a0,1346 # 800578 <main+0x2e>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	54250513          	addi	a0,a0,1346 # 800598 <main+0x4e>
...
exit(int error_code) {
  ...
  80012a:	47a50513          	addi	a0,a0,1146 # 8005a0 <main+0x56>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	43e78793          	addi	a5,a5,1086 # 8005b8 <main+0x6e>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001da:	416a8a93          	addi	s5,s5,1046 # 8005ec <main+0xa2>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001e2:	62ab8b93          	addi	s7,s7,1578 # 800808 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800438:	1b460613          	addi	a2,a2,436 # 8005e8 <main+0x9e>
  ...
  80044a:	19260613          	addi	a2,a2,402 # 8005d8 <main+0x8e>
  ...
  80045c:	17840413          	addi	s0,s0,376 # 8005d0 <main+0x86>
  ...
  8004e6:	0ee40413          	addi	s0,s0,238 # 8005d0 <main+0x86>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004fc:	0d9a0a13          	addi	s4,s4,217 # 8005d1 <main+0x87>
...
main(void) {
  80055c:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  80055e:	b45ff0ef          	jal	ra,8000a2 <cprintf>
    panic("FAIL: T.T\n");
