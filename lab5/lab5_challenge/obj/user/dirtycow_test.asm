...
exit(int error_code) {
  ...
  8000d4:	4f050513          	addi	a0,a0,1264 # 8005c0 <main+0xc8>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80012c:	4b078793          	addi	a5,a5,1200 # 8005d8 <main+0xe0>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800188:	488a8a93          	addi	s5,s5,1160 # 80060c <main+0x114>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800190:	69cb8b93          	addi	s7,s7,1692 # 800828 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e6:	22660613          	addi	a2,a2,550 # 800608 <main+0x110>
  ...
  8003f8:	20460613          	addi	a2,a2,516 # 8005f8 <main+0x100>
  ...
  80040a:	1ea40413          	addi	s0,s0,490 # 8005f0 <main+0xf8>
  ...
  800494:	16040413          	addi	s0,s0,352 # 8005f0 <main+0xf8>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004aa:	14ba0a13          	addi	s4,s4,331 # 8005f1 <main+0xf9>
...
int main(void) {
  ...
  8004fe:	3f650513          	addi	a0,a0,1014 # 8008f0 <error_string+0xc8>
int main(void) {
  800502:	f022                	sd	s0,32(sp)
  800504:	ec26                	sd	s1,24(sp)
  800506:	e84a                	sd	s2,16(sp)
  800508:	00001417          	auipc	s0,0x1
  80050c:	af840413          	addi	s0,s0,-1288 # 801000 <data.0>
  800510:	f406                	sd	ra,40(sp)
  800512:	00000497          	auipc	s1,0x0
  800516:	3ff48493          	addi	s1,s1,1023 # 800911 <error_string+0xe9>
    cprintf("DirtyCOW vulnerability test\n");
  80051a:	b27ff0ef          	jal	ra,800040 <cprintf>
  80051e:	8922                	mv	s2,s0
  800520:	86a6                	mv	a3,s1
  800522:	8722                	mv	a4,s0
  ...
  800524:	04f00793          	li	a5,79
        data[i] = original[i];
  800528:	00f70023          	sb	a5,0(a4)
    for (int i = 0; original[i] != '\0'; i++) {
  80052c:	0006c783          	lbu	a5,0(a3)
  800530:	0705                	addi	a4,a4,1
  800532:	0685                	addi	a3,a3,1
  800534:	fbf5                	bnez	a5,800528 <main+0x30>
    }
    data[13] = '\0';  // 确保字符串结束
  800536:	00001797          	auipc	a5,0x1
  80053a:	ac078ba3          	sb	zero,-1321(a5) # 80100d <data.0+0xd>
    // 现在：data[] = "ORIGINAL DATA"
    // 物理页面P: 包含这个字符串，父进程有写权限
    
    // fork创建子进程
    int pid = fork(); 
  80053e:	ba1ff0ef          	jal	ra,8000de <fork>
    // fork后：父子共享页面P
    // 父进程PTE: W=1
    // 子进程PTE: W=0, COW=1
    
    if (pid == 0) {
  800542:	c539                	beqz	a0,800590 <main+0x98>
        if (data[0] == 'M') {
  ...
  800544:	06a05363          	blez	a0,8005aa <main+0xb2>
        int exit_code = 0;
        waitpid(pid, &exit_code);  // 等待子进程结束
  800548:	006c                	addi	a1,sp,12
        int exit_code = 0;
  80054a:	c602                	sw	zero,12(sp)
        waitpid(pid, &exit_code);  // 等待子进程结束
  80054c:	b95ff0ef          	jal	ra,8000e0 <waitpid>
        
        // 父进程检查数据是否被破坏
        int is_original = 1;
        for (int i = 0; original[i] != '\0'; i++) {
  800550:	04f00793          	li	a5,79
  800554:	a031                	j	800560 <main+0x68>
  800556:	0004c783          	lbu	a5,0(s1)
  80055a:	0405                	addi	s0,s0,1
  80055c:	0485                	addi	s1,s1,1
  80055e:	c395                	beqz	a5,800582 <main+0x8a>
            if (data[i] != original[i]) {
  800560:	00044703          	lbu	a4,0(s0)
  800564:	fef709e3          	beq	a4,a5,800556 <main+0x5e>
        }
  ...
  80056c:	42850513          	addi	a0,a0,1064 # 800990 <error_string+0x168>
  800570:	ad1ff0ef          	jal	ra,800040 <cprintf>
    ...
    return 0;
  800574:	4501                	li	a0,0
  800576:	70a2                	ld	ra,40(sp)
  800578:	7402                	ld	s0,32(sp)
  80057a:	64e2                	ld	s1,24(sp)
  80057c:	6942                	ld	s2,16(sp)
  80057e:	6145                	addi	sp,sp,48
  800580:	8082                	ret
            cprintf("Test completed - no corruption should occur\n");
  800582:	00000517          	auipc	a0,0x0
  800586:	3de50513          	addi	a0,a0,990 # 800960 <error_string+0x138>
  80058a:	ab7ff0ef          	jal	ra,800040 <cprintf>
  80058e:	b7dd                	j	800574 <main+0x7c>
        for (int i = 0; i < 100; i++) {
  800590:	04d00793          	li	a5,77
            cprintf("Child: data modified (expected behavior)\n");
  800594:	00000517          	auipc	a0,0x0
  800598:	38c50513          	addi	a0,a0,908 # 800920 <error_string+0xf8>
  80059c:	00f90023          	sb	a5,0(s2)
  8005a0:	aa1ff0ef          	jal	ra,800040 <cprintf>
        exit(0);
  8005a4:	4501                	li	a0,0
  8005a6:	b23ff0ef          	jal	ra,8000c8 <exit>
        cprintf("fork failed\n");
  8005aa:	00000517          	auipc	a0,0x0
  8005ae:	3a650513          	addi	a0,a0,934 # 800950 <error_string+0x128>
  8005b2:	a8fff0ef          	jal	ra,800040 <cprintf>
        return -1;
  8005b6:	557d                	li	a0,-1
  8005b8:	bf7d                	j	800576 <main+0x7e>
