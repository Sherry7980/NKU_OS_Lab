...
exit(int error_code) {
  ...
  8000d4:	62050513          	addi	a0,a0,1568 # 8006f0 <main+0x1f8>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80012c:	5e078793          	addi	a5,a5,1504 # 800708 <main+0x210>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800188:	5b8a8a93          	addi	s5,s5,1464 # 80073c <main+0x244>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  800190:	7ccb8b93          	addi	s7,s7,1996 # 800958 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e6:	35660613          	addi	a2,a2,854 # 800738 <main+0x240>
  ...
  8003f8:	33460613          	addi	a2,a2,820 # 800728 <main+0x230>
  ...
  80040a:	31a40413          	addi	s0,s0,794 # 800720 <main+0x228>
  ...
  800494:	29040413          	addi	s0,s0,656 # 800720 <main+0x228>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004aa:	27ba0a13          	addi	s4,s4,635 # 800721 <main+0x229>
...
int main(void) {
  8004f8:	7139                	addi	sp,sp,-64
    cprintf("COW Test Starting...\n");
  8004fa:	00000517          	auipc	a0,0x0
  8004fe:	52650513          	addi	a0,a0,1318 # 800a20 <error_string+0xc8>
int main(void) {
  800502:	fc06                	sd	ra,56(sp)
  800504:	f426                	sd	s1,40(sp)
  800506:	f04a                	sd	s2,32(sp)
  800508:	f822                	sd	s0,48(sp)
  80050a:	ec4e                	sd	s3,24(sp)
  80050c:	e852                	sd	s4,16(sp)
    cprintf("COW Test Starting...\n");
  80050e:	b33ff0ef          	jal	ra,800040 <cprintf>
  ...
  800512:	04b00613          	li	a2,75
  800516:	07d00693          	li	a3,125
  80051a:	0af00713          	li	a4,175
  80051e:	0e100793          	li	a5,225
  800522:	45e5                	li	a1,25
  800524:	160a                	slli	a2,a2,0x22
  800526:	168a                	slli	a3,a3,0x22
  800528:	170a                	slli	a4,a4,0x22
  80052a:	178a                	slli	a5,a5,0x22
  80052c:	00001917          	auipc	s2,0x1
  800530:	ad490913          	addi	s2,s2,-1324 # 801000 <data.0>
  800534:	158a                	slli	a1,a1,0x22
  800536:	0c860613          	addi	a2,a2,200
  80053a:	19068693          	addi	a3,a3,400
  80053e:	25870713          	addi	a4,a4,600
  800542:	32078793          	addi	a5,a5,800
    }
    cprintf("Parent: initialized data\n");
  800546:	00000517          	auipc	a0,0x0
  80054a:	4f250513          	addi	a0,a0,1266 # 800a38 <error_string+0xe0>
        data[i] = i * 100;   // [0, 100, 200, ..., 900]
  80054e:	00b93023          	sd	a1,0(s2)
  800552:	00c93423          	sd	a2,8(s2)
  800556:	00d93823          	sd	a3,16(s2)
  80055a:	00e93c23          	sd	a4,24(s2)
  80055e:	02f93023          	sd	a5,32(s2)
    cprintf("Parent: initialized data\n");
  ...
  800566:	b79ff0ef          	jal	ra,8000de <fork>
  80056a:	84aa                	mv	s1,a0
  ...
  80056c:	c941                	beqz	a0,8005fc <main+0x104>
  ...
  80056e:	16a05063          	blez	a0,8006ce <main+0x1d6>
        int exit_code = 0;
        waitpid(pid, &exit_code);  // 父进程等待子进程结束
  800572:	006c                	addi	a1,sp,12
        int exit_code = 0;
  800574:	c602                	sw	zero,12(sp)
        waitpid(pid, &exit_code);  // 父进程等待子进程结束
  800576:	b6bff0ef          	jal	ra,8000e0 <waitpid>
         
        if (exit_code == 0) {
  80057a:	45b2                	lw	a1,12(sp)
  80057c:	c9ad                	beqz	a1,8005ee <main+0xf6>
            cprintf("Child completed successfully\n");
        } else {
            cprintf("Child failed with code %d\n", exit_code);
  80057e:	00000517          	auipc	a0,0x0
  800582:	5da50513          	addi	a0,a0,1498 # 800b58 <error_string+0x200>
  800586:	abbff0ef          	jal	ra,800040 <cprintf>
        }
        
        cprintf("Parent: checking data after child...\n");
  80058a:	00000517          	auipc	a0,0x0
  80058e:	5ee50513          	addi	a0,a0,1518 # 800b78 <error_string+0x220>
  800592:	aafff0ef          	jal	ra,800040 <cprintf>
        // 验证父进程的数据未受影响
        int sum = 0;
  800596:	4401                	li	s0,0
  800598:	00001797          	auipc	a5,0x1
  80059c:	a6878793          	addi	a5,a5,-1432 # 801000 <data.0>
  8005a0:	00001697          	auipc	a3,0x1
  8005a4:	a8868693          	addi	a3,a3,-1400 # 801028 <data.0+0x28>
        for (int i = 0; i < TEST_SIZE; i++) {
            sum += data[i];   // 读取的是物理页A，原始数据
  8005a8:	4398                	lw	a4,0(a5)
        for (int i = 0; i < TEST_SIZE; i++) {
  8005aa:	0791                	addi	a5,a5,4
            sum += data[i];   // 读取的是物理页A，原始数据
  8005ac:	9c39                	addw	s0,s0,a4
        for (int i = 0; i < TEST_SIZE; i++) {
  8005ae:	fef69de3          	bne	a3,a5,8005a8 <main+0xb0>
        }
        // sum = 0+100+200+...+900 = 4500 ✓
        cprintf("Parent: sum = %d (should be 4500)\n", sum);
  8005b2:	85a2                	mv	a1,s0
  8005b4:	00000517          	auipc	a0,0x0
  8005b8:	5ec50513          	addi	a0,a0,1516 # 800ba0 <error_string+0x248>
  8005bc:	a85ff0ef          	jal	ra,800040 <cprintf>
        
        if (sum == 4500 && exit_code == 0) {
  8005c0:	6785                	lui	a5,0x1
  8005c2:	19478793          	addi	a5,a5,404 # 1194 <_start-0x7fee8c>
  8005c6:	00f41563          	bne	s0,a5,8005d0 <main+0xd8>
  8005ca:	47b2                	lw	a5,12(sp)
  8005cc:	0e078763          	beqz	a5,8006ba <main+0x1c2>
            cprintf("COW Test PASSED!\n");
        } else {
            cprintf("COW Test FAILED!\n");
  8005d0:	00000517          	auipc	a0,0x0
  8005d4:	61050513          	addi	a0,a0,1552 # 800be0 <error_string+0x288>
  8005d8:	a69ff0ef          	jal	ra,800040 <cprintf>
    } else {
        cprintf("fork failed\n");
        return -1;
    }
    ...
    return 0;
  8005dc:	4501                	li	a0,0
  8005de:	70e2                	ld	ra,56(sp)
  8005e0:	7442                	ld	s0,48(sp)
  8005e2:	74a2                	ld	s1,40(sp)
  8005e4:	7902                	ld	s2,32(sp)
  8005e6:	69e2                	ld	s3,24(sp)
  8005e8:	6a42                	ld	s4,16(sp)
  8005ea:	6121                	addi	sp,sp,64
  8005ec:	8082                	ret
            cprintf("Child completed successfully\n");
  8005ee:	00000517          	auipc	a0,0x0
  8005f2:	54a50513          	addi	a0,a0,1354 # 800b38 <error_string+0x1e0>
  8005f6:	a4bff0ef          	jal	ra,800040 <cprintf>
  8005fa:	bf41                	j	80058a <main+0x92>
        cprintf("Child: reading parent's data...\n");
  8005fc:	00000517          	auipc	a0,0x0
  800600:	45c50513          	addi	a0,a0,1116 # 800a58 <error_string+0x100>
  800604:	a3dff0ef          	jal	ra,800040 <cprintf>
        for (int i = 0; i < TEST_SIZE; i++) {
  800608:	844a                	mv	s0,s2
  80060a:	00001a17          	auipc	s4,0x1
  80060e:	a1ea0a13          	addi	s4,s4,-1506 # 801028 <data.0+0x28>
        cprintf("Child: reading parent's data...\n");
  800612:	87ca                	mv	a5,s2
        int sum = 0;
  800614:	4981                	li	s3,0
            sum += data[i];   // 只是读取，页表项W=0但R=1，允许读取
  800616:	4398                	lw	a4,0(a5)
        for (int i = 0; i < TEST_SIZE; i++) {
  800618:	0791                	addi	a5,a5,4
            sum += data[i];   // 只是读取，页表项W=0但R=1，允许读取
  80061a:	013709bb          	addw	s3,a4,s3
        for (int i = 0; i < TEST_SIZE; i++) {
  80061e:	fefa1ce3          	bne	s4,a5,800616 <main+0x11e>
        cprintf("Child: sum before write = %d\n", sum);
  800622:	85ce                	mv	a1,s3
  800624:	00000517          	auipc	a0,0x0
  800628:	45c50513          	addi	a0,a0,1116 # 800a80 <error_string+0x128>
  80062c:	a15ff0ef          	jal	ra,800040 <cprintf>
        if (sum != 4500) {
  800630:	6785                	lui	a5,0x1
  800632:	19478793          	addi	a5,a5,404 # 1194 <_start-0x7fee8c>
  800636:	0af99463          	bne	s3,a5,8006de <main+0x1e6>
        cprintf("Child: writing data (trigger COW)...\n");
  80063a:	00000517          	auipc	a0,0x0
  80063e:	48e50513          	addi	a0,a0,1166 # 800ac8 <error_string+0x170>
  800642:	9ffff0ef          	jal	ra,800040 <cprintf>
            data[i] = i * 200;
  800646:	04b00613          	li	a2,75
  80064a:	07d00693          	li	a3,125
  80064e:	0af00713          	li	a4,175
  800652:	0e100793          	li	a5,225
  800656:	45e5                	li	a1,25
  800658:	160e                	slli	a2,a2,0x23
  80065a:	168e                	slli	a3,a3,0x23
  80065c:	170e                	slli	a4,a4,0x23
  80065e:	178e                	slli	a5,a5,0x23
  800660:	158e                	slli	a1,a1,0x23
  800662:	19060613          	addi	a2,a2,400
  800666:	32068693          	addi	a3,a3,800
  80066a:	4b070713          	addi	a4,a4,1200
  80066e:	64078793          	addi	a5,a5,1600
  800672:	00b93023          	sd	a1,0(s2)
  800676:	00c93423          	sd	a2,8(s2)
  80067a:	00d93823          	sd	a3,16(s2)
  80067e:	00e93c23          	sd	a4,24(s2)
  800682:	02f93023          	sd	a5,32(s2)
            sum += data[i];
  800686:	401c                	lw	a5,0(s0)
        for (int i = 0; i < TEST_SIZE; i++) {
  800688:	0411                	addi	s0,s0,4
            sum += data[i];
  80068a:	9cbd                	addw	s1,s1,a5
        for (int i = 0; i < TEST_SIZE; i++) {
  80068c:	ff441de3          	bne	s0,s4,800686 <main+0x18e>
        cprintf("Child: sum after write = %d\n", sum);
  800690:	85a6                	mv	a1,s1
  800692:	00000517          	auipc	a0,0x0
  800696:	45e50513          	addi	a0,a0,1118 # 800af0 <error_string+0x198>
  80069a:	9a7ff0ef          	jal	ra,800040 <cprintf>
        if (sum != 9000) {
  80069e:	6789                	lui	a5,0x2
  8006a0:	32878793          	addi	a5,a5,808 # 2328 <_start-0x7fdcf8>
  8006a4:	02f48263          	beq	s1,a5,8006c8 <main+0x1d0>
            cprintf("Child: ERROR - sum should be 9000\n");
  8006a8:	00000517          	auipc	a0,0x0
  8006ac:	46850513          	addi	a0,a0,1128 # 800b10 <error_string+0x1b8>
  ...
  8006be:	50e50513          	addi	a0,a0,1294 # 800bc8 <error_string+0x270>
  8006c2:	97fff0ef          	jal	ra,800040 <cprintf>
  8006c6:	bf19                	j	8005dc <main+0xe4>
        exit(0);
  8006c8:	4501                	li	a0,0
  8006ca:	9ffff0ef          	jal	ra,8000c8 <exit>
        cprintf("fork failed\n");
  8006ce:	00000517          	auipc	a0,0x0
  8006d2:	52a50513          	addi	a0,a0,1322 # 800bf8 <error_string+0x2a0>
  8006d6:	96bff0ef          	jal	ra,800040 <cprintf>
        return -1;
  8006da:	557d                	li	a0,-1
  8006dc:	b709                	j	8005de <main+0xe6>
            cprintf("Child: ERROR - sum should be 4500\n");
  8006de:	00000517          	auipc	a0,0x0
  8006e2:	3c250513          	addi	a0,a0,962 # 800aa0 <error_string+0x148>
  8006e6:	95bff0ef          	jal	ra,800040 <cprintf>
            exit(-1);
  8006ea:	557d                	li	a0,-1
  8006ec:	9ddff0ef          	jal	ra,8000c8 <exit>
