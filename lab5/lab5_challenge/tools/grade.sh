...
run_test -prog 'cowtest'  -check default_check                                       \
        ...
        'COW Test Starting...'                                  \
        'Parent: initialized data'                              \
        'Child: reading parent'\''s data...'                    \
        'Child: sum before write = 4500'                        \
        'Child: writing data (trigger COW)...'                  \
        'Child: sum after write = 9000'                         \
        'Parent: checking data after child...'                  \
        'Parent: sum = 4500 (should be 4500)'                   \
        'COW Test PASSED!'                                      \
        'all user-mode processes have quit.'                    \
        'init check memory pass.'                               \
    ! - 'user panic at .*'
...
run_test -prog 'dirtycow_test'  -check default_check                                 \
        'kernel_execve: pid = 2, name = "dirtycow_test".'       \
        'DirtyCOW vulnerability test'                           \
        'Test completed - no corruption should occur'           \
        'all user-mode processes have quit.'                    \
        'init check memory pass.'                               \
    ! - 'user panic at .*'
