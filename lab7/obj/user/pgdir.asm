...
exit(int error_code) {
  ...
  8000ce:	45650513          	addi	a0,a0,1110 # 800520 <main+0x2e>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800126:	41678793          	addi	a5,a5,1046 # 800538 <main+0x46>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800182:	3eea8a93          	addi	s5,s5,1006 # 80056c <main+0x7a>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  80018a:	602b8b93          	addi	s7,s7,1538 # 800788 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003e0:	18c60613          	addi	a2,a2,396 # 800568 <main+0x76>
  ...
  8003f2:	16a60613          	addi	a2,a2,362 # 800558 <main+0x66>
  ...
  800404:	15040413          	addi	s0,s0,336 # 800550 <main+0x5e>
  ...
  80048e:	0c640413          	addi	s0,s0,198 # 800550 <main+0x5e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004a4:	0b1a0a13          	addi	s4,s4,177 # 800551 <main+0x5f>
...
main(void) {
  ...
  8004f6:	be3ff0ef          	jal	ra,8000d8 <getpid>
  ...
  800504:	b3dff0ef          	jal	ra,800040 <cprintf>
    print_pgdir();
  800508:	bd3ff0ef          	jal	ra,8000da <print_pgdir>
    cprintf("pgdir pass.\n");
