...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	5d250513          	addi	a0,a0,1490 # 800608 <main+0xc0>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	5d250513          	addi	a0,a0,1490 # 800628 <main+0xe0>
...
exit(int error_code) {
  ...
  800128:	50c50513          	addi	a0,a0,1292 # 800630 <main+0xe8>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017c:	4d078793          	addi	a5,a5,1232 # 800648 <main+0x100>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d8:	4a8a8a93          	addi	s5,s5,1192 # 80067c <main+0x134>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001e0:	6bcb8b93          	addi	s7,s7,1724 # 800898 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800436:	24660613          	addi	a2,a2,582 # 800678 <main+0x130>
  ...
  800448:	22460613          	addi	a2,a2,548 # 800668 <main+0x120>
  ...
  80045a:	20a40413          	addi	s0,s0,522 # 800660 <main+0x118>
  ...
  8004e4:	18040413          	addi	s0,s0,384 # 800660 <main+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004fa:	16ba0a13          	addi	s4,s4,363 # 800661 <main+0x119>
...
main(void) {
  800552:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  800554:	b4fff0ef          	jal	ra,8000a2 <cprintf>
    int i;
  ...
  8005d8:	acbff0ef          	jal	ra,8000a2 <cprintf>
