...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	61a50513          	addi	a0,a0,1562 # 800650 <main+0xf2>
__panic(const char *file, int line, const char *fmt, ...) {
...
exit(int error_code) {
  ...
  800138:	53c50513          	addi	a0,a0,1340 # 800670 <main+0x112>
...
umain(void) {
  ...
  80014c:	412000ef          	jal	ra,80055e <main>
    exit(ret);
  800150:	fddff0ef          	jal	ra,80012c <exit>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800192:	4fa78793          	addi	a5,a5,1274 # 800688 <main+0x12a>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001ee:	4d2a8a93          	addi	s5,s5,1234 # 8006bc <main+0x15e>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001f6:	6e6b8b93          	addi	s7,s7,1766 # 8008d8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80044c:	27060613          	addi	a2,a2,624 # 8006b8 <main+0x15a>
  ...
  80045e:	24e60613          	addi	a2,a2,590 # 8006a8 <main+0x14a>
  ...
  800470:	23440413          	addi	s0,s0,564 # 8006a0 <main+0x142>
  ...
  8004fa:	1aa40413          	addi	s0,s0,426 # 8006a0 <main+0x142>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800510:	195a0a13          	addi	s4,s4,405 # 8006a1 <main+0x143>
...
main(void) {
  ...
  800562:	e822                	sd	s0,16(sp)
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800564:	bdfff0ef          	jal	ra,800142 <fork>
  ...
  80058a:	bbbff0ef          	jal	ra,800144 <waitpid>
  80058e:	e115                	bnez	a0,8005b2 <main+0x54>
  800590:	4732                	lw	a4,12(sp)
  800592:	67b1                	lui	a5,0xc
  800594:	eaf78793          	addi	a5,a5,-337 # beaf <_start-0x7f4171>
  ...
  8005cc:	a5bff0ef          	jal	ra,800026 <__panic>
    assert(waitpid(pid, (void *)0xC0000000) != 0);
  ...
  800632:	a71ff0ef          	jal	ra,8000a2 <cprintf>
  800636:	4429                	li	s0,10
        for (i = 0; i < 10; i ++) {
  800638:	347d                	addiw	s0,s0,-1
            yield();
  80063a:	b0dff0ef          	jal	ra,800146 <yield>
        for (i = 0; i < 10; i ++) {
  80063e:	fc6d                	bnez	s0,800638 <main+0xda>
        exit(0xbeaf);
  800640:	6531                	lui	a0,0xc
  800642:	eaf50513          	addi	a0,a0,-337 # beaf <_start-0x7f4171>
  800646:	ae7ff0ef          	jal	ra,80012c <exit>
