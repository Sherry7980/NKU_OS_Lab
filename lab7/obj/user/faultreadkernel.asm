...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	54250513          	addi	a0,a0,1346 # 800578 <main+0x30>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	54250513          	addi	a0,a0,1346 # 800598 <main+0x50>
...
exit(int error_code) {
  ...
  800128:	47c50513          	addi	a0,a0,1148 # 8005a0 <main+0x58>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017c:	44078793          	addi	a5,a5,1088 # 8005b8 <main+0x70>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d8:	418a8a93          	addi	s5,s5,1048 # 8005ec <main+0xa4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001e0:	62cb8b93          	addi	s7,s7,1580 # 800808 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800436:	1b660613          	addi	a2,a2,438 # 8005e8 <main+0xa0>
  ...
  800448:	19460613          	addi	a2,a2,404 # 8005d8 <main+0x90>
  ...
  80045a:	17a40413          	addi	s0,s0,378 # 8005d0 <main+0x88>
  ...
  8004e4:	0f040413          	addi	s0,s0,240 # 8005d0 <main+0x88>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004fa:	0dba0a13          	addi	s4,s4,219 # 8005d1 <main+0x89>
...
main(void) {
  80055a:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  80055c:	b47ff0ef          	jal	ra,8000a2 <cprintf>
    panic("FAIL: T.T\n");
  ...
  800572:	ab5ff0ef          	jal	ra,800026 <__panic>
