...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	60250513          	addi	a0,a0,1538 # 800638 <main+0xd2>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	60250513          	addi	a0,a0,1538 # 800658 <main+0xf2>
...
exit(int error_code) {
  ...
  80013e:	52650513          	addi	a0,a0,1318 # 800660 <main+0xfa>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80019a:	4e278793          	addi	a5,a5,1250 # 800678 <main+0x112>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f6:	4baa8a93          	addi	s5,s5,1210 # 8006ac <main+0x146>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001fe:	6ceb8b93          	addi	s7,s7,1742 # 8008c8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800454:	25860613          	addi	a2,a2,600 # 8006a8 <main+0x142>
  ...
  800466:	23660613          	addi	a2,a2,566 # 800698 <main+0x132>
  ...
  800478:	21c40413          	addi	s0,s0,540 # 800690 <main+0x12a>
  ...
  800502:	19240413          	addi	s0,s0,402 # 800690 <main+0x12a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800518:	17da0a13          	addi	s4,s4,381 # 800691 <main+0x12b>
...
main(void) {
  ...
  800574:	b2fff0ef          	jal	ra,8000a2 <cprintf>
    if ((pid = fork()) == 0) {
  800578:	bd1ff0ef          	jal	ra,800148 <fork>
  ...
  800586:	b1dff0ef          	jal	ra,8000a2 <cprintf>
        while (1);
  ...
  800596:	b0dff0ef          	jal	ra,8000a2 <cprintf>
    ...
    yield();
  80059a:	bb3ff0ef          	jal	ra,80014c <yield>
    yield();
  80059e:	bafff0ef          	jal	ra,80014c <yield>
    yield();
  8005a2:	babff0ef          	jal	ra,80014c <yield>

    cprintf("I am the parent.  Killing the child...\n");
  8005a6:	00000517          	auipc	a0,0x0
  8005aa:	45a50513          	addi	a0,a0,1114 # 800a00 <error_string+0x138>
  8005ae:	af5ff0ef          	jal	ra,8000a2 <cprintf>

    assert((ret = kill(pid)) == 0);
  8005b2:	8522                	mv	a0,s0
  8005b4:	b9bff0ef          	jal	ra,80014e <kill>
  ...
  8005c4:	adfff0ef          	jal	ra,8000a2 <cprintf>

    assert((ret = waitpid(pid, NULL)) == 0);
  8005c8:	4581                	li	a1,0
  8005ca:	8522                	mv	a0,s0
  8005cc:	b7fff0ef          	jal	ra,80014a <waitpid>
  ...
  800610:	a17ff0ef          	jal	ra,800026 <__panic>
    assert((ret = kill(pid)) == 0);
  ...
  80062e:	9f9ff0ef          	jal	ra,800026 <__panic>
