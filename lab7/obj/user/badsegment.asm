...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	53250513          	addi	a0,a0,1330 # 800568 <main+0x20>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	53250513          	addi	a0,a0,1330 # 800588 <main+0x40>
...
exit(int error_code) {
  ...
  800128:	46c50513          	addi	a0,a0,1132 # 800590 <main+0x48>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017c:	43078793          	addi	a5,a5,1072 # 8005a8 <main+0x60>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d8:	408a8a93          	addi	s5,s5,1032 # 8005dc <main+0x94>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001e0:	61cb8b93          	addi	s7,s7,1564 # 8007f8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800436:	1a660613          	addi	a2,a2,422 # 8005d8 <main+0x90>
  ...
  800448:	18460613          	addi	a2,a2,388 # 8005c8 <main+0x80>
  ...
  80045a:	16a40413          	addi	s0,s0,362 # 8005c0 <main+0x78>
  ...
  8004e4:	0e040413          	addi	s0,s0,224 # 8005c0 <main+0x78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004fa:	0cba0a13          	addi	s4,s4,203 # 8005c1 <main+0x79>
...
main(void) {
  80055c:	e406                	sd	ra,8(sp)
    panic("FAIL: T.T\n");
  80055e:	ac9ff0ef          	jal	ra,800026 <__panic>
