...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	5d250513          	addi	a0,a0,1490 # 800608 <main+0xac>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	5d250513          	addi	a0,a0,1490 # 800628 <main+0xcc>
...
exit(int error_code) {
  ...
  800134:	50050513          	addi	a0,a0,1280 # 800630 <main+0xd4>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800190:	4bc78793          	addi	a5,a5,1212 # 800648 <main+0xec>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001ec:	494a8a93          	addi	s5,s5,1172 # 80067c <main+0x120>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001f4:	6a8b8b93          	addi	s7,s7,1704 # 800898 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80044a:	23260613          	addi	a2,a2,562 # 800678 <main+0x11c>
  ...
  80045c:	21060613          	addi	a2,a2,528 # 800668 <main+0x10c>
  ...
  80046e:	1f640413          	addi	s0,s0,502 # 800660 <main+0x104>
  ...
  8004f8:	16c40413          	addi	s0,s0,364 # 800660 <main+0x104>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  80050e:	157a0a13          	addi	s4,s4,343 # 800661 <main+0x105>
...
main(void) {
  ...
  80057a:	02000413          	li	s0,32
    ...
    for (; n > 0; n --) {
        if (wait() != 0) {
  80057e:	bc3ff0ef          	jal	ra,800140 <wait>
  ...
  800586:	fc65                	bnez	s0,80057e <main+0x22>
    ...
    if (wait() == 0) {
  800588:	bb9ff0ef          	jal	ra,800140 <wait>
  ...
  8005b0:	af3ff0ef          	jal	ra,8000a2 <cprintf>
            exit(0);
  8005b4:	4501                	li	a0,0
  8005b6:	b73ff0ef          	jal	ra,800128 <exit>
            panic("wait stopped early\n");
  ...
  800600:	a27ff0ef          	jal	ra,800026 <__panic>
